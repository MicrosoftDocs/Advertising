...
| `{mmcMerchantId}/regions`<br/>`{mmcMerchantId}/regions/batch` | GET | Get a list of regions in the store.<br><br>Set `{mmcMerchantId}` to the MMC store ID. | Request: N/A<br>Response: Regions |
