...
|CancellationDetails|Optional.<br /><br />A description of the details for cancellation. For example, You may cancel free of charge until 5 days before arrival. You will be charged the cost of the first night if you cancel in the 5 days before arrival. |Text
...
|Element|Description|Children
|-|-|-
|MinOccupancy|Data type is integer.<br /><br />The minimum number of guests that can stay in a room. For example, if set to 2, this room cannot be booked for a single guest. <br /><br />For example, use USD for United States Dollar. |None
