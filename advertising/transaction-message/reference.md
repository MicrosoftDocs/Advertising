...
|FreeCancellationAvailable|Optional.<br />Data type is Boolean.<br /><br />A value that determines whether the room has free cancellation available or not. Valid values are:<br/><br/>- 1 (true)<br/><br/>- 0 (false)<br/><br/>- true<br/><br/>- false<br/><br/>The default is *false*. You can use `<FreeCancellationAvailable/>` as a shortcut for *true*.
