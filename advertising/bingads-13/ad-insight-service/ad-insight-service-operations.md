...
|[GetAutoApplyOptInStatus](getautoapplyoptinstatus.md)|Gets the status of auto-apply recommendations for a single account.|The number of distinct recommendation types is no more than 100 |
...
|[SetAutoApplyOptInStatus](setautoapplyoptinstatus.md)|Sets the status of auto-apply recommendations for a single account.|The number of distinct recommendation types is no more than 100 |
