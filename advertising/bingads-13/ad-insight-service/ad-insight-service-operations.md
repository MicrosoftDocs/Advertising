...
|[GetPerformanceInsightsDetailDataByAccountId](getperformanceinsightsdetaildatabyaccountid.md)|Gets the performance insights detail data for a single account.|
