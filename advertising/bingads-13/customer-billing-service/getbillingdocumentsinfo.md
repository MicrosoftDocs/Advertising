...
|<a name="returninvoicenumber"></a>ReturnInvoiceNumber|Include the invoice number with the request.|**boolean**|
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetBillingDocumentsInfoResponse xmlns="https://bingads.microsoft.com/Billing/v13">
      <BillingDocumentsInfo xmlns:e21="https://bingads.microsoft.com/Customer/v13/Entities" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e21:BillingDocumentInfo>
          ...
          <e21:Amount>ValueHere</e21:Amount>
          <e21:CurrencyCode d4p1:nil="false">ValueHere</e21:CurrencyCode>
          <e21:DocumentDate d4p1:nil="false">ValueHere</e21:DocumentDate>
          <e21:DocumentId d4p1:nil="false">ValueHere</e21:DocumentId>
          <e21:CustomerId d4p1:nil="false">ValueHere</e21:CustomerId>
          <e21:CampaignId d4p1:nil="false">ValueHere</e21:CampaignId>
          <e21:DocumentNumber d4p1:nil="false">ValueHere</e21:DocumentNumber>
        </e21:BillingDocumentInfo>
...
```POST
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerBilling/v13/BillingDocumentsInfo/Query
```

-----

## <a name="request"></a>Request Elements
The *GetBillingDocumentsInfoRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetBillingDocumentsInfoResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
