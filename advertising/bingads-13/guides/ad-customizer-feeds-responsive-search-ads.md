...
> [!TIP]
> Local storage of these entities is useful in cases where the Campaign, AdGroup and Keyword level records require updates. [Learn more](../guides/services-protocol.md#store-your-entity-identifiers-locally).
