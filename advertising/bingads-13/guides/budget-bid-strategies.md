...
> [!NOTE]
> [EnhancedCpc](#enhancedcpc) and [MaxClicks](#maxclicks) are currently the only supported bidding strategies when you select Japanese as your campaign language.
