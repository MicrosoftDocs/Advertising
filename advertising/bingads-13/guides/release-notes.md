...
- **Campaign Management API**:
  - New element *AutoGeneratedAssetsEnabled* in *ResponsiveSearchAdSetting* data object: [ResponsiveSearchAdSetting](../campaign-management-service/responsivesearchadsetting.md#autogeneratedassetsenabled).
