...
### <a name="newapiinterfaces-february2026"></a>New API Interfaces  

- **Campaign Management API**:
  - New element *AutoGeneratedAssetsEnabled* in *ResponsiveSearchAdsSetting* data object: [ResponsiveSearchAdsSetting](../campaign-management-service/responsivesearchadssetting.md#autogeneratedassetsenabled).

## <a name="december2025"></a>December 2025
...
- **Ad Insight API**:
  - New _GetAudienceBreakdown_ service operation: [GetAudienceBreakdown](../ad-insight-service/getaudiencebreakdown.md).
  - New _GetBidLandscapeByCampaignIds_ service operation: [GetBidLandscapeByCampaignIds](../ad-insight-service/getbidlandscapebycampaignids.md).
- **Campaign Management API**:
  - New criterion type: [TopicCriterion](../campaign-management-service/topiccriterion.md).
  - Support multiple _campaignIds_ and _adGroupIds_ in [ImpressionBasedRemarketingList](../campaign-management-service/impressionbasedremarketinglist.md).
  - New field _Industry_ in [UetTag](../campaign-management-service/uettag.md#industry).
  - New fields _TrackingUrlTemplate_, _FinalUrlSuffix_ and _UrlCustomParameters_ in [AssetGroup](../campaign-management-service/assetgroup.md).
  - New fields _IsPolitical_ and _BidStrategyScope_ in [Campaign](../campaign-management-service/campaign.md).
  - New fields _CurrencyCode_, _ReportingTimeZone_, and _Scope_ in [BidStrategy](../campaign-management-service/bidstrategy.md).
  - Add value _DataDriven_ in [AttributionModelType](../campaign-management-service/attributionmodeltype.md).
  - New option _NewTopicTargets_ and _UpdateTopicTargets_ in [GoogleImportOption](../campaign-management-service/googleimportoption.md).
  - Asset-based editorial: Support _TextAsset_ and _ImageAsset_ in [EntityType](../campaign-management-service/entitytype.md).
- **Reporting API**:
  - New _BidStrategyReport_: [BidStrategyReportColumn](../reporting-service/bidstrategyreportcolumn.md), [BidStrategyReportFilter](../reporting-service/bidstrategyreportfilter.md), and [BidStrategyReportRequest](../reporting-service/bidstrategyreportrequest.md).
  - New column _ConversionDelay_ in [AccountPerformanceReportColumn](../reporting-service/accountperformancereportcolumn.md#conversiondelay), [CampaignPerformanceReportColumn](../reporting-service/campaignperformancereportcolumn.md#conversiondelay) and [GoalsAndFunnelsReportColumn](../reporting-service/goalsandfunnelsreportcolumn.md#conversiondelay).
  - New column _CostPerConversion_ in [AssetGroupPerformanceReportColumn](../reporting-service/assetgroupperformancereportcolumn.md#costperconversion).

### <a name="bulkservice-december2025"></a>Bulk Service

- Add bulk mappings: [BulkAdGroupTopicCriterion](../bulk-service/ad-group-topic-criterion.md), [BulkContentPlacement](../bulk-service/content-placement.md), and [BulkTopic](../bulk-service/topic.md).
...
The Bing Ads .NET and Java SDKs are updated. For details, please see release notes for Microsoft Advertising [.NET](https://github.com/BingAds/BingAds-dotNet-SDK/releases/tag/v13.0.26), [Java](https://github.com/BingAds/BingAds-Java-SDK/releases/tag/v13.0.26), [PHP](https://github.com/BingAds/BingAds-PHP-SDK/releases/tag/v13.0.26), [Python](https://github.com/BingAds/BingAds-Python-SDK/releases/tag/v13.0.26) SDK version 13.0.26.
...
The Bing Ads .NET and Java SDKs are updated. For details, please see release notes for Microsoft Advertising [.NET](https://github.com/BingAds/BingAds-dotNet-SDK/releases/tag/v13.0.25.3), [Java](https://github.com/BingAds/BingAds-Java-SDK/releases/tag/v13.0.25.3), [PHP](https://github.com/BingAds/BingAds-PHP-SDK/releases/tag/v13.0.25.3), [Python](https://github.com/BingAds/BingAds-Python-SDK/releases/tag/v13.0.25.3) SDK version 13.0.25.3.
...
The Bing Ads .NET and Java SDKs are updated. For details, please see release notes for Microsoft Advertising [.NET](https://github.com/BingAds/BingAds-dotNet-SDK/releases/tag/v13.0.25), [Java](https://github.com/BingAds/BingAds-Java-SDK/releases/tag/v13.0.25), [PHP](https://github.com/BingAds/BingAds-PHP-SDK/releases/tag/v13.0.25), [Python](https://github.com/BingAds/BingAds-Python-SDK/releases/tag/v13.0.25) SDK version 13.0.25.
...
The Bing Ads .NET and Java SDKs are updated. For details, please see release notes for Microsoft Advertising [.NET](https://github.com/BingAds/BingAds-dotNet-SDK/releases/tag/v13.0.24), [Java](https://github.com/BingAds/BingAds-Java-SDK/releases/tag/v13.0.24), [PHP](https://github.com/BingAds/BingAds-PHP-SDK/releases/tag/v13.0.24), [Python](https://github.com/BingAds/BingAds-Python-SDK/releases/tag/v13.0.24) SDK version 13.0.24.
...
- Support for new audience type Impression Based Remarketing List: [Impression Based Remarketing List Record](../bulk-service/impression-based-remarketing-list.md), [Campaign Impression Based Remarketing List Association Record](../bulk-service/campaign-impression-based-remarketing-list-association.md), [Campaign Negative Impression Based Remarketing List Association Record](../bulk-service/campaign-negative-impression-based-remarketing-list-association.md), [Ad Group Impression Based Remarketing List Association Record](../bulk-service/ad-group-impression-based-remarketing-list-association.md), [Ad Group Negative Impression Based Remarketing List Association Record](../bulk-service/ad-group-negative-impression-based-remarketing-list-association.md).
...
- [New API Interfaces](#newapiinterfaces-march2024)  
- [Bulk Service](#bulkservice-march2024)  
- [Bing Ads API SDK Updates](#sdk-march2024)

### <a name="newapiinterfaces-march2024"></a>New API Interfaces  

- **Campaign Management API**: [AddDataExclusions](../campaign-management-service/adddataexclusions.md), [GetDataExclusionsByAccountId](../campaign-management-service/getdataexclusionsbyaccountid.md), [GetDataExclusionsByIds](../campaign-management-service/getseasonalityadjustmentsbyids.md), [UpdateDataExclusions](../campaign-management-service/updatedataexclusions.md), [DeleteDataExclusions](../campaign-management-service/deletedataexclusions.md) for [DataExclusion](../campaign-management-service/dataexclusion.md). [AddSeasonalityAdjustment](../campaign-management-service/addseasonalityadjustments.md), [GetSeasonalityAdjustmentsByAccountId](../campaign-management-service/getseasonalityadjustmentsbyaccountid.md), [GetSeasonalityAdjustmentByIds](../campaign-management-service/getseasonalityadjustmentsbyids.md), [UpdateSeasonalityAdjustments](../campaign-management-service/updateseasonalityadjustments.md), [DeleteSeasonalityAdjustments](../campaign-management-service/deleteseasonalityadjustments.md) for [SeasonalityAdjustment](../campaign-management-service/seasonalityadjustment.md). [CustomerShare](../campaign-management-service/customershare.md) for [CustomerList](../campaign-management-service/customerlist.md).

### <a name="bulkservice-march2024"></a>Bulk Service
...
### <a name="sdk-march2024"></a>Bing Ads API SDK Updates

The Bing Ads .NET, Java, PHP, and Python SDKs are updated. For details please see release notes for Microsoft Advertising [.NET](https://github.com/BingAds/BingAds-dotNet-SDK/releases/tag/v13.0.19), [Java](https://github.com/BingAds/BingAds-Java-SDK/releases/tag/v13.0.19), [PHP](https://github.com/BingAds/BingAds-PHP-SDK/releases/tag/v13.0.19), and [Python](https://github.com/BingAds/BingAds-Python-SDK/releases/tag/v13.0.19) SDK version 13.0.19.
...
- [New API Interfaces](#newapiinterfaces-august2023)  
- [Bulk Service](#bulkservice-august2023)  
- [Bing Ads API SDK Updates](#sdk-august2023)

### <a name="newapiinterfaces-august2023"></a>New API Interfaces  
