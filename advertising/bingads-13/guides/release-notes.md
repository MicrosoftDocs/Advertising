...
- **Campaign Management API**:
  - New element *AutoGeneratedAssetsEnabled* in *ResponsiveSearchAdSetting* data object: [ResponsiveSearchAdSetting](../campaign-management-service/responsivesearchadssetting.md#autogeneratedassetsenabled).
