---
title: AdvertiserAccount Data Object Test - Customer Management
ms.service: bing-ads
ms.subservice: customer-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines an advertiser account.(test)
---
# AdvertiserAccount Data Object Test - Customer Management
...
|CCM|The municipal registration number, or Cadastro de contribuinte mobiliario (CCM), of the legal entity.<br/><br/>**Add:** Optional<br/>**Update:** Optional. If no value is set for the update, this setting is not changed.|Brazil|
