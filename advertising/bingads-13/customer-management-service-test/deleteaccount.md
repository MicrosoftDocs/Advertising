---
title: DeleteAccount Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Deletes an account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteAccount Service Operation Test - Customer Management
Deletes an account.
...
## <a name="request"></a>Request Elements
The *DeleteAccountRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
