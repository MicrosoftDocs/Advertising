---
title: DeleteUser Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Deletes a user.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteUser Service Operation Test - Customer Management
Deletes a user.  
...
## <a name="request"></a>Request Elements
The *DeleteUserRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *DeleteUserResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
