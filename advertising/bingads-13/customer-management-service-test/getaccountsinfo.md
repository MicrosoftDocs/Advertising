---
title: GetAccountsInfo Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Gets the identifiers, names, and numbers of accounts that are accessible from the specified customer.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAccountsInfo Service Operation Test - Customer Management
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetAccountsInfoResponse xmlns="https://bingads.microsoft.com/Customer/v13">
      <AccountsInfo xmlns:e463="https://bingads.microsoft.com/Customer/v13/Entities" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e463:AccountInfo>
          <e463:Id>ValueHere</e463:Id>
          <e463:Name d4p1:nil="false">ValueHere</e463:Name>
          <e463:Number d4p1:nil="false">ValueHere</e463:Number>
          <e463:AccountLifeCycleStatus>ValueHere</e463:AccountLifeCycleStatus>
          <e463:PauseReason d4p1:nil="false">ValueHere</e463:PauseReason>
        </e463:AccountInfo>
      </AccountsInfo>
...
```Post
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerManagement/v13/AccountsInfo/Query
```

-----

## <a name="request"></a>Request Elements
The *GetAccountsInfoRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetAccountsInfoResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
