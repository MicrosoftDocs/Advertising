---
title: AccountFinancialStatus Value Set Test - Customer Management
ms.service: bing-ads
ms.subservice: customer-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible financial status values of an account.(test)
---
# AccountFinancialStatus Value Set Test - Customer Management
