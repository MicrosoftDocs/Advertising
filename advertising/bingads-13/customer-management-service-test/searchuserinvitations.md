---
title: SearchUserInvitations Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Searches for user invitations that match the request criteria.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# SearchUserInvitations Service Operation Test - Customer Management
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <SearchUserInvitationsRequest xmlns="https://bingads.microsoft.com/Customer/v13">
      <Predicates xmlns:e521="https://bingads.microsoft.com/Customer/v13/Entities" i:nil="false">
        <e521:Predicate>
          <e521:Field i:nil="false">ValueHere</e521:Field>
          <e521:Operator>ValueHere</e521:Operator>
          <e521:Value i:nil="false">ValueHere</e521:Value>
        </e521:Predicate>
      </Predicates>
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <SearchUserInvitationsResponse xmlns="https://bingads.microsoft.com/Customer/v13">
      <UserInvitations xmlns:e522="https://bingads.microsoft.com/Customer/v13/Entities" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e522:UserInvitation>
          <e522:Id>ValueHere</e522:Id>
          <e522:FirstName d4p1:nil="false">ValueHere</e522:FirstName>
          <e522:LastName d4p1:nil="false">ValueHere</e522:LastName>
          <e522:Email d4p1:nil="false">ValueHere</e522:Email>
          <e522:CustomerId>ValueHere</e522:CustomerId>
          <e522:RoleId>ValueHere</e522:RoleId>
          <e522:AccountIds d4p1:nil="false" xmlns:a1="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
            <a1:long>ValueHere</a1:long>
          </e522:AccountIds>
          <e522:ExpirationDate>ValueHere</e522:ExpirationDate>
          <e522:Lcid>ValueHere</e522:Lcid>
        </e522:UserInvitation>
      </UserInvitations>
...
```Post
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerManagement/v13/UserInvitations/Search
```

-----

## <a name="request"></a>Request Elements
The *SearchUserInvitationsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *SearchUserInvitationsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
