---
title: FindAccounts Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Gets a list of accounts owned by the specified customer that match the specified filter criteria.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# FindAccounts Service Operation Test - Customer Management
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <FindAccountsResponse xmlns="https://bingads.microsoft.com/Customer/v13">
      <AccountsInfo xmlns:e451="https://bingads.microsoft.com/Customer/v13/Entities" d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <e451:AccountInfo>
          <e451:Id>ValueHere</e451:Id>
          <e451:Name d4p1:nil="false">ValueHere</e451:Name>
          <e451:Number d4p1:nil="false">ValueHere</e451:Number>
          <e451:AccountLifeCycleStatus>ValueHere</e451:AccountLifeCycleStatus>
          <e451:PauseReason d4p1:nil="false">ValueHere</e451:PauseReason>
        </e451:AccountInfo>
      </AccountsInfo>
...
```Post
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerManagement/v13/Accounts/Find
```

-----

## <a name="request"></a>Request Elements
The *FindAccountsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *FindAccountsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
