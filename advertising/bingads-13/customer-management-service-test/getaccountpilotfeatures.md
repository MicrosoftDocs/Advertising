---
title: GetAccountPilotFeatures Service Operation Test - Customer Management
ms.service: bing-ads
...
description: Gets a list of the feature pilot IDs that are enabled for an ad account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAccountPilotFeatures Service Operation Test - Customer Management
...
```POST
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerManagement/v13/AccountPilotFeatures/Query
```

-----

## <a name="request"></a>Request Elements
The *GetAccountPilotFeaturesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
