---
title: UpdateExperiments Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the specified experiments.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateExperiments Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *UpdateExperimentsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
