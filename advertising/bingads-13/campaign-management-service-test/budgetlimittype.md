---
title: BudgetLimitType Value Set Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible budget limit types that you can specify for a campaign.(test)
---
# BudgetLimitType Value Set Test - Campaign Management
