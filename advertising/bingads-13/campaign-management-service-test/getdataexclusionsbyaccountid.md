---
title: GetDataExclusionsByAccountId Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the data exclusions associated with an account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetDataExclusionsByAccountId Service Operation Test - Campaign Management
