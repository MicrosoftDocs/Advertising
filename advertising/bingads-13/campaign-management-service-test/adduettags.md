---
title: AddUetTags Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds new Universal Event Tracking (UET) tags that you can add to your website to allow Microsoft Advertising to collect actions people take on your website.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddUetTags Service Operation Test - Campaign Management
