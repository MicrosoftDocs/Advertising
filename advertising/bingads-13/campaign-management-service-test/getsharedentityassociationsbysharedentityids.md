---
title: GetSharedEntityAssociationsBySharedEntityIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the negative keyword list to campaign associations by negative keyword list IDs, or website exclusion list to ad account associations by website exclusion list IDs.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetSharedEntityAssociationsBySharedEntityIds Service Operation Test - Campaign Management
