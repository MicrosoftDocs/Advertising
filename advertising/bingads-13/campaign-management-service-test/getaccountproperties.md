---
title: GetAccountProperties Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets account level properties by name.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAccountProperties Service Operation Test - Campaign Management
