---
title: DeleteMedia Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes the specified media from an account's media library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteMedia Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *DeleteMediaRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
