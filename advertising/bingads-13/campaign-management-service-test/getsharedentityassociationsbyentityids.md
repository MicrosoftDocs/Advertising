---
title: GetSharedEntityAssociationsByEntityIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the negative keyword list to campaign associations by campaign IDs, or website exclusion list to ad account associations by ad account IDs.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetSharedEntityAssociationsByEntityIds Service Operation Test - Campaign Management
