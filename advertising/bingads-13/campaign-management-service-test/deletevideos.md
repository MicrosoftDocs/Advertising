---
title: DeleteVideos Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes one or more videos from the account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteVideos Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *DeleteVideosRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *DeleteVideosResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
