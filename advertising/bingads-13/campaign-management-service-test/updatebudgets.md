---
title: UpdateBudgets Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the specified budgets in the account's shared budget library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateBudgets Service Operation Test - Campaign Management
...
```Put
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/Budgets
```

# [Sandbox URL](#tab/sandbox)

```Put
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/Budgets
```

-----

## <a name="request"></a>Request Elements
The *UpdateBudgetsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *UpdateBudgetsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
