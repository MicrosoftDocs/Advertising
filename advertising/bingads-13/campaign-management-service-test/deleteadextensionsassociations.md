---
title: DeleteAdExtensionsAssociations Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Removes the specified association from the respective campaigns or ad groups.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteAdExtensionsAssociations Service Operation Test - Campaign Management
