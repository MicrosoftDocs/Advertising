---
title: GetCampaignCriterionsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified campaign criterions.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetCampaignCriterionsByIds Service Operation Test - Campaign Management
