---
title: SetNegativeSitesToAdGroups Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Sets the negative site URLs directly to ad groups.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# SetNegativeSitesToAdGroups Service Operation Test - Campaign Management
