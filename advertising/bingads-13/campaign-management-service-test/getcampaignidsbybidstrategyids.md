---
title: GetCampaignIdsByBidStrategyIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the campaign identifiers that are associated with the specified portfolio bid strategies.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetCampaignIdsByBidStrategyIds Service Operation Test - Campaign Management
