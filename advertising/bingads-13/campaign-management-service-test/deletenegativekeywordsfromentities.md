---
title: DeleteNegativeKeywordsFromEntities Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes negative keywords from the specified campaign or ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteNegativeKeywordsFromEntities Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *DeleteNegativeKeywordsFromEntitiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
