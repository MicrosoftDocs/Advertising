---
title: GetImportJobsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets import jobs by their type and identifiers.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetImportJobsByIds Service Operation Test - Campaign Management
