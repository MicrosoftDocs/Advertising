---
title: GetSharedEntities Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets negative keyword lists or website exclusion lists.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetSharedEntities Service Operation Test - Campaign Management
