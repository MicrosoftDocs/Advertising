---
title: GetGeoLocationsFileUrl Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets a temporary URL that you can use to download a file that contains identifiers for the geographical locations that you can target or exclude.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetGeoLocationsFileUrl Service Operation Test - Campaign Management
