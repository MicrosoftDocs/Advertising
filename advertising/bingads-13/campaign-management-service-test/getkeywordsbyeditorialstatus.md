---
title: GetKeywordsByEditorialStatus Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Retrieves the keywords with the specified editorial review status.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordsByEditorialStatus Service Operation Test - Campaign Management
