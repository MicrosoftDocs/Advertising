---
title: AddBidStrategies Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds bid strategies to an account's portfolio bid strategy library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddBidStrategies Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *AddBidStrategiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
