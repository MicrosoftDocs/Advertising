---
title: RadiusCriterion Data Object Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a criterion that can be used to show ads to users within the radius of a specific geographical location.(test)
---
# RadiusCriterion Data Object Test - Campaign Management
...
```json
{
  ...
  "LatitudeDegrees": "DoubleValueHere",
  "LongitudeDegrees": "DoubleValueHere",
  "Name": "ValueHere",
  "Radius": "LongValueHere",
