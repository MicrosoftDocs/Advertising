---
title: DeleteLabelAssociations Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes label associations.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteLabelAssociations Service Operation Test - Campaign Management
