---
title: GetLabelAssociationsByEntityIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets label associations by entity identifiers.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetLabelAssociationsByEntityIds Service Operation Test - Campaign Management
