---
title: GetAdGroupsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified ad groups within the specified campaign.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAdGroupsByIds Service Operation Test - Campaign Management
        ...
        <AdGroup>
          ...
          <Settings d4p1:nil="false">
            <Setting d4p1:type="-- derived type specified here with the appropriate prefix --">
              ...
              <Details xmlns:e216="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
                <e216:ArrayOfKeyValuePairOfstringstring>
...
Below is an example that is applicable if the type of [BiddingScheme](biddingscheme.md) is [CommissionBiddingScheme](commissionbiddingscheme.md), [Setting](setting.md) is [CallToActionSetting](calltoactionsetting.md), [BatchError](batcherror.md) is [EditorialError](editorialerror.md).
