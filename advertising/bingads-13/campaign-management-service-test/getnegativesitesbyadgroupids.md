---
title: GetNegativeSitesByAdGroupIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the negative sites URLs that are assigned directly to ad groups.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetNegativeSitesByAdGroupIds Service Operation Test - Campaign Management
