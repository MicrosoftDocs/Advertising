---
title: GetLabelsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets labels by label identifiers.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetLabelsByIds Service Operation Test - Campaign Management
