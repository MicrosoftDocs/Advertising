---
title: AddImportJobs Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Creates a new import job.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddImportJobs Service Operation Test - Campaign Management
