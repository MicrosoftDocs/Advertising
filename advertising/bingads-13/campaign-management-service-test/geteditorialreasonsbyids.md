---
title: GetEditorialReasonsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the reasons why the specified entities failed editorial review and whether the issue is appealable.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetEditorialReasonsByIds Service Operation Test - Campaign Management
