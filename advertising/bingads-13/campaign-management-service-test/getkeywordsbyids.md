---
title: GetKeywordsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Retrieves the specified keywords.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordsByIds Service Operation Test - Campaign Management
