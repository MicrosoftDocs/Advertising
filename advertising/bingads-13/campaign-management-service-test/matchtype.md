---
title: MatchType Value Set Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible match types for a keyword or negative keyword.(test)
---
# MatchType Value Set Test - Campaign Management
