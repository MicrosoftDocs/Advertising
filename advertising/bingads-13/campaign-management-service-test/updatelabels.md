---
title: UpdateLabels Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the labels within the account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateLabels Service Operation Test - Campaign Management
