---
title: DeleteLabels Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes one or more labels from the account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteLabels Service Operation Test - Campaign Management
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <DeleteLabelsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <DeleteLabelsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
## <a name="request"></a>Request Elements
The *DeleteLabelsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *DeleteLabelsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
