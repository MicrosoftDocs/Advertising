---
title: GetAudiencesByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Retrieves the specified audiences from the specified account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAudiencesByIds Service Operation Test - Campaign Management
