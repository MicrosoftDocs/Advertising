---
title: GetMediaMetaDataByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified media meta data from an account's media library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetMediaMetaDataByIds Service Operation Test - Campaign Management
...
```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/MediaMetaData/QueryByIds
```

-----

## <a name="request"></a>Request Elements
The *GetMediaMetaDataByIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetMediaMetaDataByIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
...
Below is an example that is applicable if the type of [MediaRepresentation](mediarepresentation.md) is [ImageMediaRepresentation](imagemediarepresentation.md), [BatchError](batcherror.md) is [EditorialError](editorialerror.md).
