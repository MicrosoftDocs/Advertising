---
title: BMCStoreSubType Value Set Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible values for Microsoft Merchant Center store sub types.(test)
---
# BMCStoreSubType Value Set Test - Campaign Management
