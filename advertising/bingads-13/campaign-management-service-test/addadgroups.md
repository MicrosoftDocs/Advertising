---
title: AddAdGroups Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds new ad groups to a specified campaign.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddAdGroups Service Operation Test - Campaign Management
        ...
        <AdGroup>
          ...
          <Settings i:nil="false">
            <Setting i:type="-- derived type specified here with the appropriate prefix --">
              ...
              <Details xmlns:e48="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
                <e48:ArrayOfKeyValuePairOfstringstring>
