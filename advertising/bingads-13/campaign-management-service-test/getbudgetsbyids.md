---
title: GetBudgetsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified budgets from the account's shared budget library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBudgetsByIds Service Operation Test - Campaign Management
