---
title: DeleteImportJobs Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes the import jobs.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteImportJobs Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *DeleteImportJobsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *DeleteImportJobsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
