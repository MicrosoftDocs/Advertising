---
title: DeleteBudgets Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes budgets from the account's shared budget library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteBudgets Service Operation Test - Campaign Management
...
## <a name="request"></a>Request Elements
The *DeleteBudgetsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
