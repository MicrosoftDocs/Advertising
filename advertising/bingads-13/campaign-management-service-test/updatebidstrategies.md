---
title: UpdateBidStrategies Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates bid strategies in an account's portfolio bid strategy library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateBidStrategies Service Operation Test - Campaign Management
...
The *UpdateBidStrategiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request. The elements must be in the same order as shown in the [Request SOAP](#request-soap). 
...
|-----------|---------------|-------------|
|<a name="bidstrategies"></a>BidStrategies|An array of [BidStrategy](bidstrategy.md) objects to update in the account's portfolio bid strategy library.<br/><br/>You can include a maximum of 100 bid strategies in a single call.<br/><br/>The account is determined by the required *CustomerAccountId* header element.|[BidStrategy](bidstrategy.md) array|

### <a name="request-header"></a>Request Header Elements
[!INCLUDE[request-header](./includes/request-header.md)]

## <a name="response"></a>Response Elements
The *UpdateBidStrategiesResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response SOAP](#response-soap).
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  <s:Header xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
    <Action mustUnderstand="1">UpdateBidStrategies</Action>
  ...
  <s:Body>
    <UpdateBidStrategiesRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <UpdateBidStrategiesResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
```
```python
response=campaignmanagement_service.UpdateBidStrategies(
	BidStrategies=BidStrategies)
```
...
## <a name="request"></a>Request Elements
The *UpdateBidStrategiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *UpdateBidStrategiesResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
