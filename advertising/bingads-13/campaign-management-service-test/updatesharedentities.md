---
title: UpdateSharedEntities Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the negative keyword lists or website exclusion lists.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateSharedEntities Service Operation Test - Campaign Management
    ...
    <UpdateSharedEntitiesRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <SharedEntities i:nil="false">
        <SharedEntity i:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e421="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
            <e421:KeyValuePairOfstringstring>
              <e421:key i:nil="false">ValueHere</e421:key>
              <e421:value i:nil="false">ValueHere</e421:value>
            </e421:KeyValuePairOfstringstring>
    ...
    <UpdateSharedEntitiesResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e422="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e422:KeyValuePairOfstringstring>
              <e422:key d4p1:nil="false">ValueHere</e422:key>
              <e422:value d4p1:nil="false">ValueHere</e422:value>
            </e422:KeyValuePairOfstringstring>
          </ForwardCompatibilityMap>
...
```Put
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/SharedEntities
```

-----

## <a name="request"></a>Request Elements
The *UpdateSharedEntitiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *UpdateSharedEntitiesResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
