---
title: GetAdExtensionsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified ad extensions from the account's ad extension library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAdExtensionsByIds Service Operation Test - Campaign Management
