---
title: AddAdGroupCriterions Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds one or more ad group criterions.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddAdGroupCriterions Service Operation Test - Campaign Management
