---
title: AddAds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds one or more ads to an ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddAds Service Operation Test - Campaign Management
