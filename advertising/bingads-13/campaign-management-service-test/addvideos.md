---
title: AddVideos Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds one or more videos to an account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddVideos Service Operation Test - Campaign Management
