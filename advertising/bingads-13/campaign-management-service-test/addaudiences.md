---
title: AddAudiences Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds one or more audiences.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddAudiences Service Operation Test - Campaign Management
    ...
    <AddAudiencesRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <Audiences i:nil="false">
        <Audience i:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e65="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
