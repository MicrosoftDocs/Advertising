---
title: GetNegativeKeywordsByEntityIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the negative keywords that are assigned directly to campaigns or ad groups.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetNegativeKeywordsByEntityIds Service Operation Test - Campaign Management
...
```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/NegativeKeywords/QueryByEntityIds
```

-----

## <a name="request"></a>Request Elements
The *GetNegativeKeywordsByEntityIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
