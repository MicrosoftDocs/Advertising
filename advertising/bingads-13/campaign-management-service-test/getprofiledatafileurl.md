---
title: GetProfileDataFileUrl Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets a temporary URL that you can use to download industry or job function profile data.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetProfileDataFileUrl Service Operation Test - Campaign Management
...
```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/ProfileDataFileUrl/Query
```

-----

## <a name="request"></a>Request Elements
The *GetProfileDataFileUrlRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
