---
title: GetKeywordsByAdGroupId Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the keywords within an ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordsByAdGroupId Service Operation Test - Campaign Management
    ...
    <GetKeywordsByAdGroupIdResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <Keywords d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <Keyword>
          ...
          <ForwardCompatibilityMap xmlns:e301="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e301:KeyValuePairOfstringstring>
              <e301:key d4p1:nil="false">ValueHere</e301:key>
              <e301:value d4p1:nil="false">ValueHere</e301:value>
            </e301:KeyValuePairOfstringstring>
...
```Post
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByAdGroupId
```

# [Sandbox URL](#tab/sandbox)

```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByAdGroupId
```

-----

## <a name="request"></a>Request Elements
The *GetKeywordsByAdGroupIdRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetKeywordsByAdGroupIdResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
