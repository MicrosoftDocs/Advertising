---
title: GetSeasonalityAdjustmentsByAccountId Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the seasonality adjustments associated with an account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetSeasonalityAdjustmentsByAccountId Service Operation Test - Campaign Management
