---
title: DeleteAdGroups Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes one or more ad groups from the specified campaign.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteAdGroups Service Operation Test - Campaign Management
