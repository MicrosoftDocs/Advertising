---
title: ImageAdExtension Data Object Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines an ad extension that specifies an image with alternative text to include in an expanded text ad.(test)
---
# ImageAdExtension Data Object Test - Campaign Management
...
|<a name="sourcetype"></a>SourceType|Reserved.|**string**|
