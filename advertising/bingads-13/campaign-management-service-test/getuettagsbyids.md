---
title: GetUetTagsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the specified Universal Event Tracking (UET) tags.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetUetTagsByIds Service Operation Test - Campaign Management
