---
title: AgeRange Value Set Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible age range values that you can use to target ads to people.(test)
---
# AgeRange Value Set Test - Campaign Management
