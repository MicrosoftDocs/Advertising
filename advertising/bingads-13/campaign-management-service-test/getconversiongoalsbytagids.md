---
title: GetConversionGoalsByTagIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the conversion goals that use the specified UET tags.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetConversionGoalsByTagIds Service Operation Test - Campaign Management
