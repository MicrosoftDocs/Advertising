---
title: AddNegativeKeywordsToEntities Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds negative keywords to the specified campaign or ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddNegativeKeywordsToEntities Service Operation Test - Campaign Management
