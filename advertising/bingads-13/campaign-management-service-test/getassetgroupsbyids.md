---
title: GetAssetGroupsByIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Retrieves specified AssetGroups.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAssetGroupsByIds Service Operation Test - Campaign Management
