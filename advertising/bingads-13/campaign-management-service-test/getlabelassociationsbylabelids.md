---
title: GetLabelAssociationsByLabelIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets label associations by label identifiers.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetLabelAssociationsByLabelIds Service Operation Test - Campaign Management
...
```Post
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/LabelAssociations/QueryByLabelIds
```

# [Sandbox URL](#tab/sandbox)

```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/LabelAssociations/QueryByLabelIds
```

-----

## <a name="request"></a>Request Elements
The *GetLabelAssociationsByLabelIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetLabelAssociationsByLabelIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
