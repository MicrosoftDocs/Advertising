---
title: DeleteDataExclusions Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Deletes the specified data exclusions from the specified account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DeleteDataExclusions Service Operation Test - Campaign Management
