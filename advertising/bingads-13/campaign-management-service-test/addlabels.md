---
title: AddLabels Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds one or more labels to an account.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddLabels Service Operation Test - Campaign Management
