---
title: AdRotationType Value Set Test - Campaign Management
ms.service: bing-ads
ms.subservice: campaign-management-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible ad rotation types that you can apply to an ad group.(test)
---
# AdRotationType Value Set Test - Campaign Management
