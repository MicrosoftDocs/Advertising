---
title: AddBudgets Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Adds new budgets to the account's shared budget library.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AddBudgets Service Operation Test - Campaign Management
