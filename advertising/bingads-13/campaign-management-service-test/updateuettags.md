---
title: UpdateUetTags Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the specified Universal Event Tracking (UET) tags.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateUetTags Service Operation Test - Campaign Management
