---
title: GetNegativeSitesByCampaignIds Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the negative site URLs that are assigned directly to campaigns.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetNegativeSitesByCampaignIds Service Operation Test - Campaign Management
...
```Post
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/NegativeSites/QueryByCampaignIds
```

# [Sandbox URL](#tab/sandbox)

```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/NegativeSites/QueryByCampaignIds
```

-----

## <a name="request"></a>Request Elements
The *GetNegativeSitesByCampaignIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
