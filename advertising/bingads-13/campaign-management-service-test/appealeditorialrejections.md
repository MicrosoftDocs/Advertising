---
title: AppealEditorialRejections Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Appeals ads or keywords that failed editorial review.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# AppealEditorialRejections Service Operation Test - Campaign Management
...
```Post
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/EditorialRejectionsAppeal/Appeal
```

# [Sandbox URL](#tab/sandbox)

```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/EditorialRejectionsAppeal/Appeal
```

-----

## <a name="request"></a>Request Elements
The *AppealEditorialRejectionsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
