---
title: ApplyCustomerListItems Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Defines the ApplyCustomerListItems service operation.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# ApplyCustomerListItems Service Operation Test - Campaign Management
Defines the ApplyCustomerListItems service operation.

> [!WARNING]
> The ApplyCustomerListItems service operation is deprecated for both internal and external users.
...
```Post
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/CustomerListItemsApply/Apply
```

# [Sandbox URL](#tab/sandbox)

```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/CustomerListItemsApply/Apply
```

-----

## <a name="request"></a>Request Elements
The *ApplyCustomerListItemsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *ApplyCustomerListItemsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
