---
title: UpdateKeywords Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Updates the keywords within a specified ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# UpdateKeywords Service Operation Test - Campaign Management
