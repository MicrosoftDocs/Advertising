---
title: GetAccountMigrationStatuses Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Gets the migration status info for the specified accounts.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAccountMigrationStatuses Service Operation Test - Campaign Management
...
```Post
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/AccountMigrationStatuses/Query
```

-----

## <a name="request"></a>Request Elements
The *GetAccountMigrationStatusesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
