---
title: SetSharedEntityAssociations Service Operation Test - Campaign Management
ms.service: bing-ads
...
description: Sets the negative keyword list to campaign associations, or website exclusion list to ad account associations.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# SetSharedEntityAssociations Service Operation Test - Campaign Management
