---
title: DownloadCampaignsByAccountIds Service Operation Test - Bulk
ms.service: bing-ads
...
description: Downloads settings and performance data for all of the account's campaigns.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# DownloadCampaignsByAccountIds Service Operation Test - Bulk
...
Below is an example that is applicable if the type of [ApplicationFault](applicationfault.md) is [AdApiFaultDetail](adapifaultdetail.md), [BatchError](batcherror.md) is [EditorialError](editorialerror.md).
