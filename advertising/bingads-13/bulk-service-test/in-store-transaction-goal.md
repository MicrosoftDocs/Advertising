...
Defines an in-store transaction goal that can be uploaded and downloaded in a bulk file.

Use this type of goal to track every time someone completes a transaction in your store.
