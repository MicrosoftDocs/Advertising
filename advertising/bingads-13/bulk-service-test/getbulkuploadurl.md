---
title: GetBulkUploadUrl Service Operation Test - Bulk
ms.service: bing-ads
...
description: Submits a request for a URL where a bulk upload file may be posted.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBulkUploadUrl Service Operation Test - Bulk
...
```Post
https://bulk.api.sandbox.bingads.microsoft.com/Bulk/v13/BulkUploadUrl/Query
```

-----

## <a name="request"></a>Request Elements
The *GetBulkUploadUrlRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
