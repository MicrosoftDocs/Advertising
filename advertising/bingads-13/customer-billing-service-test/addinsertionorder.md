...
Below is an example that is applicable if the type of [ApplicationFault](applicationfault.md) is [AdApiFaultDetail](adapifaultdetail.md), [ApiFault](apifault.md) is [ApiBatchFault](apibatchfault.md).
