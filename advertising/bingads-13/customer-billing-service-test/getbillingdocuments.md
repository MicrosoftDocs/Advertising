---
title: GetBillingDocuments Service Operation Test - Customer Billing
ms.service: bing-ads
...
description: Gets the specified billing documents.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBillingDocuments Service Operation Test - Customer Billing
