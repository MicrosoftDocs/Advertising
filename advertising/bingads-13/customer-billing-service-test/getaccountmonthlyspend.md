---
title: GetAccountMonthlySpend Service Operation Test - Customer Billing
ms.service: bing-ads
...
description: Gets the amount spent by the account in the specified month.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetAccountMonthlySpend Service Operation Test - Customer Billing
...
```POST
https://clientcenter.api.sandbox.bingads.microsoft.com/CustomerBilling/v13/AccountMonthlySpend/Query
```

-----

## <a name="request"></a>Request Elements
The *GetAccountMonthlySpendRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
