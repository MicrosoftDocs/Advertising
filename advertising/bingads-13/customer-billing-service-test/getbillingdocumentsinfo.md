---
title: GetBillingDocumentsInfo Service Operation Test - Customer Billing
ms.service: bing-ads
...
description: Gets a list of objects that contains billing document identification information, for example the billing document identifier, amount, and account identifier.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBillingDocumentsInfo Service Operation Test - Customer Billing
