---
title: InsertionOrderStatus Value Set Test - Customer Billing
ms.service: bing-ads
ms.subservice: customer-billing-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the possible status values of an InsertionOrder.(test)
---
# InsertionOrderStatus Value Set Test - Customer Billing
...
|<a name="declined"></a>Declined|You have declined an order created by Microsoft Advertising, or the order you created has been declined. Submit a new order, contact your Microsoft Advertising account manager, or [contact support](https://about.ads.microsoft.com/support).<br/><br/>You can also use this value on update to decline an insertion order if its [Status](insertionorder.md#status) is PendingUserReview. An internal Microsoft Advertising system admin cannot use this value on update.|
