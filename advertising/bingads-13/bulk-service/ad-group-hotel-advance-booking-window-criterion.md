---
title: "Ad Group Hotel Advance Booking Criterion Record - Bulk"
ms.service: bing-ads
ms.topic: "article"
author: rgaritta
ms.author: v-rgaritta
description: Describes the Ad Group Hotel Advance Booking Criterion fields in a Bulk file.
dev_langs:
  - csharp
ms.subservice: bulk-api
---
# Ad Group Location Criterion Record - Bulk
Defines an ad group hotel advance booking criterion that can be uploaded and downloaded in a bulk file.
