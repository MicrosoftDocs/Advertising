---
title: "Account Shared Content Negative Keyword Record - Bulk"
ms.service: bing-ads
...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Describes the Account Shared Content Negative Keyword fields in a Bulk file.
dev_langs:
  - csharp
---
...
Format Version,,,,,,,,,,6.0
Account Shared Content Negative Keyword,Active,,-19,,,ClientIdGoesHere,,shoes,Exact,
```

For an *Account Shared Content Negative Keyword* record, the following attribute fields are available in the [Bulk File Schema](bulk-file-schema.md).
