...
var bulkCampaignDisclaimerAdExtension = new BulkCampaignDisclaimerAdExtension
{
    ...
    AdExtensionIdToEntityIdAssociation = new AdExtensionIdToEntityIdAssociation
    {
        ...
        AdExtensionId = disclaimerAdExtensionIdKey,
...
For a *Campaign Disclaimer Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](bulk-file-schema.md). 
