...
|<a name="contentplacement"></a>ContentPlacement|Include Content Placement records in the download data, which you can use to create placement criterions.|
...
|<a name="topic"></a>Topic|Include Topic records, which you can use to create topic criterions.|
