---
title: "Campaign Promotion Ad Extension Record - Bulk"
ms.service: bing-ads
...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Describes the Campaign Promotion Ad Extension fields in a Bulk file.
dev_langs:
  - csharp
---
...
Format Version,,,,,,,,6.0
Campaign Promotion Ad Extension,Active,-11,-1111,,,ClientIdGoesHere,,
```

If you are using the [Bing Ads SDKs](../guides/client-libraries.md) for .NET, Java, or Python, you can save time using the [BulkServiceManager](../guides/sdk-bulk-service-manager.md) to upload and download the *BulkCampaignPromotionAdExtension* object, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 

```csharp
var uploadEntities = new List<BulkEntity>();

// Map properties in the Bulk file to the BulkCampaignPromotionAdExtension
var bulkCampaignPromotionAdExtension = new BulkCampaignPromotionAdExtension
{
...
uploadEntities.Add(bulkCampaignPromotionAdExtension);
...
For a *Campaign Promotion Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](bulk-file-schema.md). 
