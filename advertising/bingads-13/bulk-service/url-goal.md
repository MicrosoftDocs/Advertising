...
The supported category values vary by conversion goal type. URL goals only support the [Download](../campaign-management-service/conversiongoalcategory#download) category.
