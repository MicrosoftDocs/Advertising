---
title: "Ad Group Video Ad Extension Record - Bulk"
ms.service: bing-ads-bulk-service
ms.topic: "article"
author: rgaritta
ms.author: v-rgaritta
description: Describes the Ad Group Video Ad Extension fields in a Bulk file.
dev_langs:
  - csharp
---
...
Format Version,,,,,,,,6.0
Ad Group Video Ad Extension,Active,-11,-1111,,,ClientIdGoesHere,,
```

If you are using the [Bing Ads SDKs](../guides/client-libraries.md) for .NET, Java, or Python, you can save time using the [BulkServiceManager](../guides/sdk-bulk-service-manager.md) to upload and download the *BulkAdGroupVideoAdExtension* object, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 

```csharp
var uploadEntities = new List<BulkEntity>();

// Map properties in the Bulk file to the BulkAdGroupVideoAdExtension
var bulkAdGroupVideoAdExtension = new BulkAdGroupVideoAdExtension
{
...
uploadEntities.Add(bulkAdGroupVideoAdExtension);
...
For an *Ad Group Video Ad Extension* record, the following attribute fields are available in the [Bulk File Schema](bulk-file-schema.md). 
