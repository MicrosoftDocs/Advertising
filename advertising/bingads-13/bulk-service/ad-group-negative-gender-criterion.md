---
title: "Ad Group Negative Gender Criterion Record - Bulk"
ms.service: bing-ads
ms.subservice: bulk-api
ms.topic: "article"
author: jonmeyers
ms.author: jonmeyers
description: Describes the Ad Group Negative Gender Criterion fields in a Bulk file.
dev_langs:
  - csharp
---
...
The following Bulk CSV example would add a new Ad Group Negative Gender Criterion if a valid [Parent Id](#parentid) value is provided. 
...
If you are using the [Bing Ads SDKs](../guides/client-libraries.md) for .NET, Java, or Python, you can save time using the [BulkServiceManager](../guides/sdk-bulk-service-manager.md) to upload and download the *BulkAdGroupNegativeGenderCriterion* object, instead of calling the service operations directly and writing custom code to parse each field in the bulk file. 
...
**Update:** Optional  
**Delete:** Required. The Status must be set to *Deleted*. To delete a specific gender criterion, you must upload the [Status](#status), [Id](#id), and [Parent Id](#parentid).
