---
title: AdDynamicTextPerformanceReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the ad dynamic text performance report data.(test)
---
# AdDynamicTextPerformanceReportFilter Data Object Test - Reporting
...
The [AdDynamicTextPerformanceReportFilter](addynamictextperformancereportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdDistribution](#addistribution), [AdGroupStatus](#adgroupstatus), [AdStatus](#adstatus), [AdType](#adtype), [DeviceType](#devicetype), [KeywordStatus](#keywordstatus), [Language](#language).
