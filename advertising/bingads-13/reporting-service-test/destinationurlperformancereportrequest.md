---
title: DestinationUrlPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a destination URL performance report request.(test)
---
# DestinationUrlPerformanceReportRequest Data Object Test - Reporting
...
```json
{
  ...
  "Type": "DestinationUrlPerformanceReportRequest",
...
The [DestinationUrlPerformanceReportRequest](destinationurlperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
