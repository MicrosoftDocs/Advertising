---
title: ConversionPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a conversion performance report request.(test)
---
# ConversionPerformanceReportRequest Data Object Test - Reporting
...
The [ConversionPerformanceReportRequest](conversionperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
