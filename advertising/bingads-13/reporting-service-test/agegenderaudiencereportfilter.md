---
title: AgeGenderAudienceReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the age and gender audience report data.(test)
---
# AgeGenderAudienceReportFilter Data Object Test - Reporting
Defines the criteria to use to filter the age and gender audience report data.

# [XML](#tab/xml)

```xml
<xs:complexType name="AgeGenderAudienceReportFilter" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
...
The [AgeGenderAudienceReportFilter](agegenderaudiencereportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdDistribution](#addistribution), [AdGroupStatus](#adgroupstatus), [CampaignStatus](#campaignstatus), [Language](#language).
