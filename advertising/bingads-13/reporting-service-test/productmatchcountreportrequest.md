---
title: ProductMatchCountReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a product match count report request that aggregates the performance data by product group for a specified time period.(test)
---
# ProductMatchCountReportRequest Data Object Test - Reporting
...
```json
{
  ...
  "Type": "ProductMatchCountReportRequest",
...
The [ProductMatchCountReportRequest](productmatchcountreportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Scope](#scope), [Time](#time).
