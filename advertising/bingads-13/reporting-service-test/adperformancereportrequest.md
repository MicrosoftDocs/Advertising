---
title: AdPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines an ad performance report request.(test)
---
# AdPerformanceReportRequest Data Object Test - Reporting
...
```xml
<xs:complexType name="AdPerformanceReportRequest" xmlns:xs="http://www.w3.org/2001/XMLSchema">
...
The [AdPerformanceReportRequest](adperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
