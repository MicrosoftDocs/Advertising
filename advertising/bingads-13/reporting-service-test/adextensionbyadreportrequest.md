---
title: AdExtensionByAdReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines an ad extension by ad report request.(test)
---
# AdExtensionByAdReportRequest Data Object Test - Reporting
...
The [AdExtensionByAdReportRequest](adextensionbyadreportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
