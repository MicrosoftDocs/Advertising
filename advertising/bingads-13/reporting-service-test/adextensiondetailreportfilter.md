---
title: AdExtensionDetailReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the ad extension detail report.(test)
---
# AdExtensionDetailReportFilter Data Object Test - Reporting
...
The [AdExtensionDetailReportFilter](adextensiondetailreportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdGroupStatus](#adgroupstatus), [AdStatus](#adstatus), [CampaignStatus](#campaignstatus), [DeviceOS](#deviceos), [DeviceType](#devicetype).
