---
title: CallDetailReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the call detail report data.(test)
---
# CallDetailReportFilter Data Object Test - Reporting
Defines the criteria to use to filter the call detail report data.

# [XML](#tab/xml)

```xml
<xs:complexType name="CallDetailReportFilter" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
...
The [CallDetailReportFilter](calldetailreportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdGroupStatus](#adgroupstatus), [CampaignStatus](#campaignstatus).
