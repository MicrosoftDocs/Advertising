---
title: DSASearchQueryPerformanceReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the DSA search query performance report data.(test)
---
# DSASearchQueryPerformanceReportFilter Data Object Test - Reporting
...
<xs:complexType name="DSASearchQueryPerformanceReportFilter" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
    ...
    <xs:element xmlns:q16="http://schemas.microsoft.com/2003/10/Serialization/Arrays" minOccurs="0" name="SearchQueries" nillable="true" type="q16:ArrayOfstring" />
  </xs:sequence>
</xs:complexType>
```
