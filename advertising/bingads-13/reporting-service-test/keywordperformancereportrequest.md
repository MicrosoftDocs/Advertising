---
title: KeywordPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a keyword performance report request.(test)
---
# KeywordPerformanceReportRequest Data Object Test - Reporting
...
The [KeywordPerformanceReportRequest](keywordperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [MaxRows](#maxrows), [Scope](#scope), [Sort](#sort), [Time](#time).
