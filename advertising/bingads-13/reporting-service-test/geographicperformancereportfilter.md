---
title: GeographicPerformanceReportFilter Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the criteria to use to filter the geographic performance report data.(test)
---
# GeographicPerformanceReportFilter Data Object Test - Reporting
...
The [GeographicPerformanceReportFilter](geographicperformancereportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdDistribution](#addistribution), [AdGroupStatus](#adgroupstatus), [AssetGroupStatus](#assetgroupstatus), [CampaignStatus](#campaignstatus), [CountryCode](#countrycode), [Language](#language).
