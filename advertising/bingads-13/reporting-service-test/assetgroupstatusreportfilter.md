---
title: AssetGroupStatusReportFilter Value Set Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the asset group status values that you can use to filter the report data.(test)
---
# AssetGroupStatusReportFilter Value Set Test - Reporting
