---
title: SearchCampaignChangeHistoryReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a change history report request.(test)
---
# SearchCampaignChangeHistoryReportRequest Data Object Test - Reporting
...
The [SearchCampaignChangeHistoryReportRequest](searchcampaignchangehistoryreportrequest.md) object has the following elements: [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
