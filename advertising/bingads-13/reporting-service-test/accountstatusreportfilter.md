---
title: AccountStatusReportFilter Value Set Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the account status values that you can use to filter the report data.(test)
---
# AccountStatusReportFilter Value Set Test - Reporting
