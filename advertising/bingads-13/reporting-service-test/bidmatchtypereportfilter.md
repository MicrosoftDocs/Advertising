---
title: BidMatchTypeReportFilter Value Set Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the bid match type values that you can use to filter the report data.(test)
---
# BidMatchTypeReportFilter Value Set Test - Reporting
