---
title: AdDistributionReportFilter Value Set Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the ad distribution medium values that you can use to filter the report data.(test)
---
# AdDistributionReportFilter Value Set Test - Reporting
