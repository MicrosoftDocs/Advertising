---
title: GoalsAndFunnelsReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a goals and funnels report request.(test)
---
# GoalsAndFunnelsReportRequest Data Object Test - Reporting
...
The [GoalsAndFunnelsReportRequest](goalsandfunnelsreportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
...
|<a name="filter"></a>Filter|The filter information to use to filter the report data.<br/><br/>The *Filter* element is not supported at this time.|[GoalsAndFunnelsReportFilter](goalsandfunnelsreportfilter.md)|
