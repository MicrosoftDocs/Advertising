---
title: ChangeEntityReportFilter Value Set Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines the types of entities by which you can filter the report data.(test)
---
# ChangeEntityReportFilter Value Set Test - Reporting
