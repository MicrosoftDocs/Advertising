---
title: ShareOfVoiceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a share of voice (SOV) report request.(test)
---
# ShareOfVoiceReportRequest Data Object Test - Reporting
...
```json
{
  ...
  "Type": "ShareOfVoiceReportRequest",
...
The [ShareOfVoiceReportRequest](shareofvoicereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
