---
title: GeographicPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a geographic performance report request.(test)
---
# GeographicPerformanceReportRequest Data Object Test - Reporting
...
The [GeographicPerformanceReportRequest](geographicperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
