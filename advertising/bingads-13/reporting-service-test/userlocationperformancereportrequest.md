---
title: UserLocationPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
ms.subservice: reporting-api
ms.topic: article
author: jonmeyers
ms.author: jonmeyers
description: Defines a user location performance report request.(test)
---
# UserLocationPerformanceReportRequest Data Object Test - Reporting
...
You can request impressions, clicks, spend, and average cost-per-click for each ad group, organized by city, country/region, metro area (Microsoft Market Area in the United States), radius, state, and account.
...
```json
{
  ...
  "Type": "UserLocationPerformanceReportRequest",
...
The [UserLocationPerformanceReportRequest](userlocationperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
