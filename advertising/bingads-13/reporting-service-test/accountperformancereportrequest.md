---
title: AccountPerformanceReportRequest Data Object Test - Reporting
ms.service: bing-ads
...
The [AccountPerformanceReportRequest](accountperformancereportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
