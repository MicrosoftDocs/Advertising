---
title: GetKeywordOpportunities Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets a list of keyword suggestions that are relevant to the specified ad group.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordOpportunities Service Operation Test - Ad Insight
...
```Post
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/KeywordOpportunities/Query
```

-----

## <a name="request"></a>Request Elements
The *GetKeywordOpportunitiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetKeywordOpportunitiesResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
...
Below is an example that is applicable if the type of [KeywordOpportunity](keywordopportunity.md) is [BroadMatchKeywordOpportunity](broadmatchkeywordopportunity.md).
