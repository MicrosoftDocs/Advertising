---
title: GetDomainCategories Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the list of categories available for the website domain and language.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetDomainCategories Service Operation Test - Ad Insight
...
```Post
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/DomainCategories/Query
```

-----

## <a name="request"></a>Request Elements
The *GetDomainCategoriesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
