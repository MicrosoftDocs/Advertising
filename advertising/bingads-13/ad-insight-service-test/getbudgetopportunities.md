---
title: GetBudgetOpportunities Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the campaign budget opportunities of the specified campaign.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBudgetOpportunities Service Operation Test - Ad Insight
...
```Post
https://adinsight.api.bingads.microsoft.com/AdInsight/v13/BudgetOpportunities/Query
```

# [Sandbox URL](#tab/sandbox)

```Post
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/BudgetOpportunities/Query
```

-----

## <a name="request"></a>Request Elements
The *GetBudgetOpportunitiesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetBudgetOpportunitiesResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
