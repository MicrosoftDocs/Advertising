---
title: GetBidLandscapeByAdGroupIds Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Given a list of existing ad groups, this operation returns for each a list of suggested bids and estimated performance statistics.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetBidLandscapeByAdGroupIds Service Operation Test - Ad Insight
