---
title: SuggestKeywordsForUrl Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Suggests the possible keywords for the content located at the specified URL.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# SuggestKeywordsForUrl Service Operation Test - Ad Insight
...
```Post
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/KeywordSuggestions/QueryByUrl
```

-----

## <a name="request"></a>Request Elements
The *SuggestKeywordsForUrlRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *SuggestKeywordsForUrlResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
