---
title: GetKeywordCategories Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the keyword categories to which the specified keywords belong.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordCategories Service Operation Test - Ad Insight
...
```POST
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/KeywordCategories/Query
```

-----

## <a name="request"></a>Request Elements
The *GetKeywordCategoriesRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
