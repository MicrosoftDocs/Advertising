---
title: GetEstimatedBidByKeywords Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the estimated bid value of one or more keywords that could result in an ad appearing in the targeted position in the search results.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetEstimatedBidByKeywords Service Operation Test - Ad Insight
...
```POST
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/EstimatedBid/QueryByKeywords
```

-----

## <a name="request"></a>Request Elements
The *GetEstimatedBidByKeywordsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
