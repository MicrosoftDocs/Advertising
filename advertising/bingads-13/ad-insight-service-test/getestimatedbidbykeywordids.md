---
title: GetEstimatedBidByKeywordIds Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the estimated bid value of one or more keywords - specified by keyword identifier - that could have resulted in an ad appearing in the targeted position in the search results in the last  7 days.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetEstimatedBidByKeywordIds Service Operation Test - Ad Insight
