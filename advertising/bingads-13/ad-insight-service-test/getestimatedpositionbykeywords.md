---
title: GetEstimatedPositionByKeywords Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the estimated position in the search results if the specified bid value would be used for the specified keywords.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetEstimatedPositionByKeywords Service Operation Test - Ad Insight
...
```Post
https://adinsight.api.sandbox.bingads.microsoft.com/AdInsight/v13/EstimatedPosition/QueryByKeywords
```

-----

## <a name="request"></a>Request Elements
The *GetEstimatedPositionByKeywordsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetEstimatedPositionByKeywordsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
