---
title: GetHistoricalSearchCount Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Gets the number of times the normalized term was used in a search during the specified time period.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# GetHistoricalSearchCount Service Operation Test - Ad Insight
