---
title: SuggestKeywordsFromExistingKeywords Service Operation Test - Ad Insight
ms.service: bing-ads
...
description: Suggests keywords that could perform better than the specified keywords.(test)
dev_langs: 
- csharp
- java
- php
- python
---
# SuggestKeywordsFromExistingKeywords Service Operation Test - Ad Insight
