...
|-----------|---------------|-------------|
|<a name="returnadditionalfields"></a>ReturnAdditionalFields|The list of additional properties that you want included within each returned *UetTag* object.|[UetTagAdditionalField](uettagadditionalfield.md)|
...
public async Task<GetUetTagsByIdsResponse> GetUetTagsByIdsAsync(
	IList<long> tagIds,
	UetTagAdditionalField? returnAdditionalFields)
{
...
static GetUetTagsByIdsResponse getUetTagsByIds(
	ArrayOflong tagIds,
	ArrayList<UetTagAdditionalField> returnAdditionalFields) throws RemoteException, Exception
{
...
```POST
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/UetTags/QueryByIds
```

# [Sandbox URL](#tab/sandbox)

```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/UetTags/QueryByIds
```

-----

## <a name="request"></a>Request Elements
The *GetUetTagsByIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
