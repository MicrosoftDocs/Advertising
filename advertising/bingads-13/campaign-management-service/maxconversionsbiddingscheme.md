...
|<a name="targetcpa"></a>TargetCpa|The target cost per action that you want to spend.<br/><br/>*Note:* TargetCpa is used by Smart Shopping and Performance Max campaigns.<br/><br/>**Add:** Optional<br/>**Update:** Optional|**double**|
