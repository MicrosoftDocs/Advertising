    ...
    <GetCampaignCriterionsByIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <CampaignCriterions d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <CampaignCriterion d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <Criterion d4p1:nil="false" d4p1:type="-- derived type specified here with the appropriate prefix --">
            ...
            <Profile d4p1:nil="false">ValueHere</Profile>
            <ProfileId>ValueHere</ProfileId>
            <ProfileType>ValueHere</ProfileType>
            ...
            <TopicName d4p1:nil="false">ValueHere</TopicName>
            ...
            <ChannelName d4p1:nil="false">ValueHere</ChannelName>
            <ChannelPlacementId>ValueHere</ChannelPlacementId>
            <ChannelPlacementName d4p1:nil="false">ValueHere</ChannelPlacementName>
            <SubChannelId d4p1:nil="false">ValueHere</SubChannelId>
            <SubChannelName d4p1:nil="false">ValueHere</SubChannelName>
          </Criterion>
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e304="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e304:KeyValuePairOfstringstring>
              <e304:key d4p1:nil="false">ValueHere</e304:key>
              <e304:value d4p1:nil="false">ValueHere</e304:value>
            </e304:KeyValuePairOfstringstring>
          </ForwardCompatibilityMap>
...
```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/CampaignCriterions/QueryByIds
```

-----

## <a name="request"></a>Request Elements
The *GetCampaignCriterionsByIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetCampaignCriterionsByIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
...
Below is an example that is applicable if the type of [CampaignCriterion](campaigncriterion.md) is [BiddableCampaignCriterion](biddablecampaigncriterion.md), [Criterion](criterion.md) is [AgeCriterion](agecriterion.md), [CriterionBid](criterionbid.md) is [BidMultiplier](bidmultiplier.md), [CriterionCashback](criterioncashback.md) is [CashbackAdjustment](cashbackadjustment.md), [BatchError](batcherror.md) is [EditorialError](editorialerror.md).
