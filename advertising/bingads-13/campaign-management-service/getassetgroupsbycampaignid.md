---
title: GetAssetGroupsByCampaignId Service Operation - Campaign Management
ms.service: bing-ads
...
description: Retrieves the specified AssetGroups.
dev_langs: 
- csharp
- java
- php
- python
---
# GetAssetGroupsByCampaignId Service Operation - Campaign Management
Retrieves the specified AssetGroups.

::: zone pivot="soap"

## <a name="request"></a>Request Elements
The *GetAssetGroupsByCampaignIdRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request. The elements must be in the same order as shown in the [Request SOAP](#request-soap). 
...
The *GetAssetGroupsByCampaignIdResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response SOAP](#response-soap).
...
```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/AssetGroups/QueryByCampaignId
```

-----

## <a name="request"></a>Request Elements
The *GetAssetGroupsByCampaignIdRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetAssetGroupsByCampaignIdResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
