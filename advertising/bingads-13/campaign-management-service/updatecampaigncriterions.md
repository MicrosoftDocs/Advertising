...
|-----------|---------------|-------------|
|<a name="campaigncriterions"></a>CampaignCriterions|The list of campaign criterions to update.<br/><br/>Campaign-level negative [DeviceCriterion](devicecriterion.md) objects are supported for Performance Max campaigns. Requests for other campaign types return the *CriterionTypeNotAllowed* error.<br/><br/>You can include up to 100 campaign criterions per request.<br/><br/>Within each [CampaignCriterion](campaigncriterion.md) object, you must specify the criterion's ID and the ID of the campaign that it belongs to.|[CampaignCriterion](campaigncriterion.md) array|
    ...
    <UpdateCampaignCriterionsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <CampaignCriterions i:nil="false">
        <CampaignCriterion i:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e463="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
            <e463:KeyValuePairOfstringstring>
              <e463:key i:nil="false">ValueHere</e463:key>
              <e463:value i:nil="false">ValueHere</e463:value>
            </e463:KeyValuePairOfstringstring>
