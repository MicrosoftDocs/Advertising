    ...
    <UpdateAdExtensionsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      ...
      <AdExtensions i:nil="false">
        <AdExtension i:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e375="http://schemas.datacontract.org/2004/07/System.Collections.Generic" i:nil="false">
            <e375:KeyValuePairOfstringstring>
              <e375:key i:nil="false">ValueHere</e375:key>
              <e375:value i:nil="false">ValueHere</e375:value>
            </e375:KeyValuePairOfstringstring>
        ...
        <BatchErrorCollection d4p1:type="-- derived type specified here with the appropriate prefix --">
          <BatchErrors d4p1:nil="false">
            <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
              ...
              <ForwardCompatibilityMap xmlns:e376="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
                <e376:KeyValuePairOfstringstring>
                  <e376:key d4p1:nil="false">ValueHere</e376:key>
                  <e376:value d4p1:nil="false">ValueHere</e376:value>
                </e376:KeyValuePairOfstringstring>
              </ForwardCompatibilityMap>
...
## <a name="request"></a>Request Elements
The *UpdateAdExtensionsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *UpdateAdExtensionsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
...
Below is an example that is applicable if the type of [AdExtension](adextension.md) is [ActionAdExtension](actionadextension.md).
