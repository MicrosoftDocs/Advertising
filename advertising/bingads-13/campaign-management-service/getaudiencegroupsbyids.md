...
public async Task<GetAudienceGroupsByIdsResponse> GetAudienceGroupsByIdsAsync(
	...
	AudienceGroupAdditionalField? returnAdditionalFields)
{
...
static GetAudienceGroupsByIdsResponse getAudienceGroupsByIds(
	ArrayOflong audienceGroupIds,
	ArrayList<AudienceGroupAdditionalField> returnAdditionalFields) throws RemoteException, Exception
{
