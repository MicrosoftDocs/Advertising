    ...
    <GetCampaignsByAccountIdResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <Campaigns d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <Campaign>
          ...
          <BidStrategyScope d4p1:nil="false">ValueHere</BidStrategyScope>
          <BiddingScheme d4p1:nil="false" d4p1:type="-- derived type specified here with the appropriate prefix --">
            ...
            <!--This field is applicable if the derived type attribute is set to ManualCpmBiddingScheme-->
            <MaxCpm d4p1:nil="false">ValueHere</MaxCpm>
          ...
          <BrandColor d4p1:nil="false">
            <AssetLink>
              <Asset d4p1:nil="false" d4p1:type="-- derived type specified here with the appropriate prefix --">
                ...
                <Excluded d4p1:nil="false">ValueHere</Excluded>
          ...
          <ForwardCompatibilityMap xmlns:e311="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e311:KeyValuePairOfstringstring>
              <e311:key d4p1:nil="false">ValueHere</e311:key>
              <e311:value d4p1:nil="false">ValueHere</e311:value>
            </e311:KeyValuePairOfstringstring>
          ...
          <MarketingObjective d4p1:nil="false">ValueHere</MarketingObjective>
          ...
          <UseCampaignLevelDates d4p1:nil="false">ValueHere</UseCampaignLevelDates>
          ...
          <Settings d4p1:nil="false">
            <Setting d4p1:type="-- derived type specified here with the appropriate prefix --">
              ...
              <Details xmlns:e312="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
                <e312:ArrayOfKeyValuePairOfstringstring>
              ...
              <Details xmlns:e313="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
                <e313:ArrayOfKeyValuePairOfstringstring>
              ...
              <BaseDomain d4p1:nil="false">ValueHere</BaseDomain>
              <!--These fields are applicable if the derived type attribute is set to AISearchSetting-->
              <AISearchEnabled>ValueHere</AISearchEnabled>
              <AutoGeneratedImageOptOut d4p1:nil="false">ValueHere</AutoGeneratedImageOptOut>
              <AutoGeneratedTextOptOut d4p1:nil="false">ValueHere</AutoGeneratedTextOptOut>
              <FinalUrlExpansionOptOut d4p1:nil="false">ValueHere</FinalUrlExpansionOptOut>
              <PageFeedIds d4p1:nil="false" xmlns:a1="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
                <a1:long>ValueHere</a1:long>
              </PageFeedIds>
              <SearchTermMatchingOptOut d4p1:nil="false">ValueHere</SearchTermMatchingOptOut>
              <!--This field is applicable if the derived type attribute is set to NetworkDistributionSetting-->
              <NetworkOption d4p1:nil="false">ValueHere</NetworkOption>
              <!--This field is applicable if the derived type attribute is set to BrandExclusionSetting-->
              <ProductAdsOptOut d4p1:nil="false">ValueHere</ProductAdsOptOut>
              <!--This field is applicable if the derived type attribute is set to ImpressionTrackingSetting-->
              <ImpressionTrackingUrl d4p1:nil="false">ValueHere</ImpressionTrackingUrl>
              <!--This field is applicable if the derived type attribute is set to ReachOptimizationGoalSetting-->
              <OptimizationGoal d4p1:nil="false">ValueHere</OptimizationGoal>
              <!--These fields are applicable if the derived type attribute is set to CampaignFrequencyCapSetting-->
              <CapValue>ValueHere</CapValue>
              <TimeGranularity>ValueHere</TimeGranularity>
              <!--These fields are applicable if the derived type attribute is set to UnifiedAutomationSetting-->
              <AudienceOptimizationOptOut d4p1:nil="false">ValueHere</AudienceOptimizationOptOut>
              <AutoGeneratedImageOptOut d4p1:nil="false">ValueHere</AutoGeneratedImageOptOut>
              <AutoGeneratedTextOptOut d4p1:nil="false">ValueHere</AutoGeneratedTextOptOut>
              <ChannelOptimizationOptOut d4p1:nil="false">ValueHere</ChannelOptimizationOptOut>
              <FinalUrlExpansionOptOut d4p1:nil="false">ValueHere</FinalUrlExpansionOptOut>
              <SearchTermMatchingOptOut d4p1:nil="false">ValueHere</SearchTermMatchingOptOut>
              <!--This field is applicable if the derived type attribute is set to CampaignPageFeedSetting-->
              <PageFeedIds d4p1:nil="false" xmlns:a1="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
                <a1:long>ValueHere</a1:long>
              </PageFeedIds>
            </Setting>
...
Below is an example that is applicable if the type of [BiddingScheme](biddingscheme.md) is [CommissionBiddingScheme](commissionbiddingscheme.md), [Asset](asset.md) is [ImageAsset](imageasset.md), [Setting](setting.md) is [AISearchSetting](aisearchsetting.md).
