...
|-----------|---------------|-------------|
|<a name="campaigncriterions"></a>CampaignCriterions|A list of criterions that help determine whether ads in each campaign get served.<br/><br/>Campaign-level negative [DeviceCriterion](devicecriterion.md) objects are supported for Performance Max campaigns. Requests for other campaign types return the *CriterionTypeNotAllowed* error.<br/><br/>You can include up to 100 campaign criterions per request.|[CampaignCriterion](campaigncriterion.md) array|
