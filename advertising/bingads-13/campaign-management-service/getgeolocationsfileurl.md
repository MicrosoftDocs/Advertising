...
|-----------|---------------|-------------|
|<a name="compressiontype"></a>CompressionType|Defines the possible compression types for the file to download.<br/><br/>This request element is optional.|[CompressionType](compressiontype.md)|
