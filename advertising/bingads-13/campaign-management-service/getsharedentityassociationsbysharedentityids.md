...
*BrandList* is a supported *SharedEntityType* for retrieving campaign-level brand list associations (*EntityType* = "Campaign"). Returned associations include the *IsExclusion* field, which indicates whether the associated brand list is applied as an exclusion list or an inclusion list.
...
|-----------|---------------|-------------|
|<a name="entitytype"></a>EntityType|The type of entity corresponding to the specified [SharedEntityIds](#sharedentityids) element.<br/><br/>Set this element to "Campaign" to get negative keyword list to campaign associations, or brand exclusion or inclusion list to campaign associations in your ad account shared library.<br/><br/>Set this element to "Account" to get website exclusion list to ad account associations in your manager account (customer) shared library.|**string**|
|<a name="returnadditionalfields"></a>ReturnAdditionalFields|The list of additional properties to include with each returned shared entity association.|[SharedEntityAssociationAdditionalField](sharedentityassociationadditionalfield.md)|
    ...
    <GetSharedEntityAssociationsBySharedEntityIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <Associations d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <SharedEntityAssociation>
          ...
          <IsExclusion d4p1:nil="false">ValueHere</IsExclusion>
      ...
      <PartialErrors d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <BatchError d4p1:type="-- derived type specified here with the appropriate prefix --">
          ...
          <ForwardCompatibilityMap xmlns:e399="http://schemas.datacontract.org/2004/07/System.Collections.Generic" d4p1:nil="false">
            <e399:KeyValuePairOfstringstring>
              <e399:key d4p1:nil="false">ValueHere</e399:key>
              <e399:value d4p1:nil="false">ValueHere</e399:value>
            </e399:KeyValuePairOfstringstring>
...
public async Task<GetSharedEntityAssociationsBySharedEntityIdsResponse> GetSharedEntityAssociationsBySharedEntityIdsAsync(
	...
	SharedEntityAssociationAdditionalField? returnAdditionalFields)
{
...
static GetSharedEntityAssociationsBySharedEntityIdsResponse getSharedEntityAssociationsBySharedEntityIds(
	...
	EntityScope sharedEntityScope,
	ArrayList<SharedEntityAssociationAdditionalField> returnAdditionalFields) throws RemoteException, Exception
{
...
```POST
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/SharedEntityAssociations/QueryBySharedEntityIds
```

# [Sandbox URL](#tab/sandbox)

```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/SharedEntityAssociations/QueryBySharedEntityIds
```

-----

## <a name="request"></a>Request Elements
The *GetSharedEntityAssociationsBySharedEntityIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetSharedEntityAssociationsBySharedEntityIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
