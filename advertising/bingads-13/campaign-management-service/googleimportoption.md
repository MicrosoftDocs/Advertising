...
|<a name="newsearchthemesforexistingassetgroups"></a>NewSearchThemesForExistingAssetGroups|Reserved.|**boolean**|
...
|<a name="updateassetgroupsasset"></a>UpdateAssetGroupsAsset|Reserved.|**boolean**|
