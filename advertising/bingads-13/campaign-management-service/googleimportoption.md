...
|<a name="newaimaxsettings"></a>NewAIMaxSettings|Reserved.|**boolean**|
...
|<a name="updateaimaxsettings"></a>UpdateAIMaxSettings|Reserved.|**boolean**|
