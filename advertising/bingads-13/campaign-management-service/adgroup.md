...
|<a name="mcpabid"></a>McpaBid|Reserved.|[Bid](bid.md)|
...
|<a name="useoptimizedtargeting"></a>UseOptimizedTargeting|Indicates if predictive targeting is enabled for an AdGroup. *Note*: UseOptimizedTargeting is only available for Audience campaigns.<br/><br/>**Add:** Optional<br/>**Update:** Optional.|**boolean**|
