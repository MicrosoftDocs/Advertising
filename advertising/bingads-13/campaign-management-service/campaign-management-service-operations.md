...
|[AddHTML5s](addhtml5s.md)|Adds array of HTML5 assets to a specified campaign.|N/A.|
...
|[AddLinkedInSegments](addlinkedinsegments.md)|Adds array of LinkedIn segments to a specified campaign.|N/A.|
...
|[DeleteHTML5s](deletehtml5s.md)|Deletes array of HTML5 assets from a specified campaign.|N/A.|
...
|[DeleteLinkedInSegments](deletelinkedinsegments.md)|Deletes array of LinkedIn segments from a specified campaign.|N/A.|
...
|[GetHTML5sByIds](gethtml5sbyids.md)|Retrieve HTML5 assets by their IDs.|N/A.|
...
|[GetUetTagAuthKey](getuettagauthkey.md)|Gets an authentication key for a UET (Universal Event Tracking) tag.|N/A.|
...
|[UpdateLinkedInSegments](updatelinkedinsegments.md)|Updates the specified LinkedIn segments.|N/A.|
