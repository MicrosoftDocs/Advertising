...
<xs:complexType name="UetTag" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
    ...
    <xs:element minOccurs="0" name="Industry" nillable="true" type="tns:UetTagIndustry">
      <xs:annotation>
        <xs:appinfo>
...
The [UetTag](uettag.md) object has the following elements: [CustomerShare](#customershare), [Description](#description), [Id](#id), [Industry](#industry), [Name](#name), [TrackingNoScript](#trackingnoscript), [TrackingScript](#trackingscript), [TrackingStatus](#trackingstatus).
...
|<a name="industry"></a>Industry|The industry of the website associated with your UET tag.<br/><br/>**Add:** Optional<br/>**Update:** Optional|[UetTagIndustry](uettagindustry.md)|
