  ...
  <xs:complexContent mixed="false">
    <xs:extension base="tns:AdGroupCriterion">
      <xs:sequence>
        ...
        <xs:element minOccurs="0" name="FinalMobileUrls" nillable="true" type="q82:ArrayOfstring" xmlns:q82="http://schemas.microsoft.com/2003/10/Serialization/Arrays" />
        <xs:element minOccurs="0" name="FinalUrlSuffix" nillable="true" type="xs:string" />
        <xs:element minOccurs="0" name="FinalUrls" nillable="true" type="q83:ArrayOfstring" xmlns:q83="http://schemas.microsoft.com/2003/10/Serialization/Arrays" />
...
|<a name="criterioncashback"></a>CriterionCashback|Defines the CriterionCashback data object.|[CriterionCashback](criterioncashback.md)|
...
|<a name="editorialstatus"></a>EditorialStatus|For future use.|[AdGroupCriterionEditorialStatus](adgroupcriterioneditorialstatus.md)|
|<a name="finalappurls"></a>FinalAppUrls|For future use.|[AppUrl](appurl.md) array|
|<a name="finalmobileurls"></a>FinalMobileUrls|For future use.|**string** array|
|<a name="finalurls"></a>FinalUrls|For future use.|**string** array|
