  ...
  <xs:complexContent mixed="false">
    <xs:extension base="tns:Asset">
      <xs:sequence>
        ...
        <xs:element minOccurs="0" name="Excluded" nillable="true" type="xs:boolean">
          <xs:annotation>
            <xs:appinfo>
              <DefaultValue EmitDefaultValue="false" xmlns="http://schemas.microsoft.com/2003/10/Serialization/" />
            </xs:appinfo>
...
The [ImageAsset](imageasset.md) object has the following elements: [CropHeight](#cropheight), [CroppingType](#croppingtype), [CropWidth](#cropwidth), [CropX](#cropx), [CropY](#cropy), [Excluded](#excluded), [SubType](#subtype), [TargetHeight](#targetheight), [TargetWidth](#targetwidth).
...
|<a name="excluded"></a>Excluded|The image asset is excluded.<br/><br/>**Get**: Available since revision 2026-08-17|**boolean**|
