---
title: GetKeywordsByAssetGroupId Service Operation - Campaign Management
ms.service: bing-ads
...
description: Gets the keywords within an asset group.
dev_langs: 
- csharp
- java
- php
- python
---
# GetKeywordsByAssetGroupId Service Operation - Campaign Management
Gets the keywords within an asset group.

::: zone pivot="soap"

## <a name="request"></a>Request Elements
The *GetKeywordsByAssetGroupIdRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request. The elements must be in the same order as shown in the [Request SOAP](#request-soap). 
...
|-----------|---------------|-------------|
|<a name="assetgroupid"></a>AssetGroupId|The identifier of the asset group that keywords are returned for.|**long**|
|<a name="returnadditionalfields"></a>ReturnAdditionalFields|The list of additional properties that you want included within each returned keyword. The additional field values enable you to get the latest features using the current version of Campaign Management API, and in the next version the corresponding elements will be included by default.<br/><br/>This request element is optional.|[KeywordAdditionalField](keywordadditionalfield.md)|

### <a name="request-header"></a>Request Header Elements
[!INCLUDE[request-header](./includes/request-header.md)]

## <a name="response"></a>Response Elements
The *GetKeywordsByAssetGroupIdResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response SOAP](#response-soap).
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  <s:Header xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
    <Action mustUnderstand="1">GetKeywordsByAssetGroupId</Action>
  ...
  <s:Body>
    <GetKeywordsByAssetGroupIdRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetKeywordsByAssetGroupIdResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
...
```csharp
public async Task<GetKeywordsByAssetGroupIdResponse> GetKeywordsByAssetGroupIdAsync(
	long assetGroupId,
	KeywordAdditionalField? returnAdditionalFields)
{
	var request = new GetKeywordsByAssetGroupIdRequest
	{
		AssetGroupId = assetGroupId,
		ReturnAdditionalFields = returnAdditionalFields
	};

	return (await CampaignManagementService.CallAsync((s, r) => s.GetKeywordsByAssetGroupIdAsync(r), request));
}
```
```java
static GetKeywordsByAssetGroupIdResponse getKeywordsByAssetGroupId(
	java.lang.Long assetGroupId,
	ArrayList<KeywordAdditionalField> returnAdditionalFields) throws RemoteException, Exception
{
	GetKeywordsByAssetGroupIdRequest request = new GetKeywordsByAssetGroupIdRequest();

	request.setAssetGroupId(assetGroupId);
	request.setReturnAdditionalFields(returnAdditionalFields);

	return CampaignManagementService.getService().getKeywordsByAssetGroupId(request);
}
```
```php
static function GetKeywordsByAssetGroupId(
	$assetGroupId,
	$returnAdditionalFields)
{
	...
	$request = new GetKeywordsByAssetGroupIdRequest();

	$request->AssetGroupId = $assetGroupId;
	$request->ReturnAdditionalFields = $returnAdditionalFields;

	return $GLOBALS['CampaignManagementProxy']->GetService()->GetKeywordsByAssetGroupId($request);
}
```
```python
response=campaignmanagement_service.GetKeywordsByAssetGroupId(
	AssetGroupId=AssetGroupId,
	ReturnAdditionalFields=ReturnAdditionalFields)
```
...
```POST
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByAssetGroupId
```

# [Sandbox URL](#tab/sandbox)

```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByAssetGroupId
```

-----

## <a name="request"></a>Request Elements
The *GetKeywordsByAssetGroupIdRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetKeywordsByAssetGroupIdResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
