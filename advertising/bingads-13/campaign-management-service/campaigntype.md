  ...
  <xs:list>
    <xs:simpleType>
      <xs:restriction base="xs:string">
        ...
        <xs:enumeration value="ObjectiveBased">
          <xs:annotation>
            <xs:appinfo>
...
The [CampaignType](campaigntype.md) value set has the following values: [App](#app), [Audience](#audience), [DynamicSearchAds](#dynamicsearchads), [Hotel](#hotel), [ObjectiveBased](#objectivebased), [PerformanceMax](#performancemax), [Search](#search), [Shopping](#shopping).
...
|<a name="objectivebased"></a>ObjectiveBased|The campaign is an objective-based campaign.|
