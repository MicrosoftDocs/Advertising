...
<xs:complexType name="Campaign" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
    ...
    <xs:element minOccurs="0" name="BidStrategyScope" nillable="true" type="tns:EntityScope">
      <xs:annotation>
        <xs:appinfo>
    ...
    <xs:element minOccurs="0" name="DealIds" nillable="true" type="q11:ArrayOflong" xmlns:q11="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
      <xs:annotation>
        <xs:appinfo>
          <DefaultValue EmitDefaultValue="false" xmlns="http://schemas.microsoft.com/2003/10/Serialization/" />
        </xs:appinfo>
    ...
    <xs:element minOccurs="0" name="ForwardCompatibilityMap" nillable="true" type="q12:ArrayOfKeyValuePairOfstringstring" xmlns:q12="http://schemas.datacontract.org/2004/07/System.Collections.Generic" />
    <xs:element minOccurs="0" name="GoalIds" nillable="true" type="q13:ArrayOflong" xmlns:q13="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
      <xs:annotation>
        <xs:appinfo>
          <DefaultValue EmitDefaultValue="false" xmlns="http://schemas.microsoft.com/2003/10/Serialization/" />
        </xs:appinfo>
    ...
    <xs:element minOccurs="0" name="PrivacyStatus" nillable="true" type="tns:CampaignPrivacyStatus">
      <xs:annotation>
        <xs:appinfo>
          <DefaultValue EmitDefaultValue="false" xmlns="http://schemas.microsoft.com/2003/10/Serialization/" />
        </xs:appinfo>
    ...
    <xs:element minOccurs="0" name="Languages" nillable="true" type="q14:ArrayOfstring" xmlns:q14="http://schemas.microsoft.com/2003/10/Serialization/Arrays" />
...
|<a name="brandcolor"></a>BrandColor|The brand color.<br/><br/>**Get**: Available since revision 2026-08-17|[AssetLink](assetlink.md) array|
|<a name="brandlogo"></a>BrandLogo|The brand logo.<br/><br/>**Get**: Available since revision 2026-08-17|[AssetLink](assetlink.md) array|
...
|<a name="businessname"></a>BusinessName|The business name.<br/><br/>**Get**: Available since revision 2026-08-17|**string**|
...
|<a name="marketingobjective"></a>MarketingObjective|Specifies the campaign objective, such as brand awareness, website visits, sales, leads, or app installs.<br/><br/>**Get**: Available since revision 2026-08-17|**string**|
...
|<a name="privacystatus"></a>PrivacyStatus|The campaign privacy status.<br/><br/>**Get**: Available since revision 2026-08-17|[CampaignPrivacyStatus](campaignprivacystatus.md)|
