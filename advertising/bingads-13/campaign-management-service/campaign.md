...
|<a name="brandcolor"></a>BrandColor|The brand color.|[AssetLink](assetlink.md) array|
|<a name="brandlogo"></a>BrandLogo|The brand logo.|[AssetLink](assetlink.md) array|
...
|<a name="businessname"></a>BusinessName|The business name.|**string**|
...
|<a name="marketingobjective"></a>MarketingObjective|Specifies the campaign objective, such as brand awareness, website visits, sales, leads, or app installs.|**string**|
...
|<a name="privacystatus"></a>PrivacyStatus|The campaign privacy status.|[CampaignPrivacyStatus](campaignprivacystatus.md)|
