...
|<a name="enddate"></a>EndDate|The date when you want your campaign to stop serving. *Note*: Currently, this will only be honored for Audience campaigns. This field is required if you select the budget type as *LifetimeBudgetStandard*. The end date can't be more than one year after the start date.|**dateTime**|
...
|<a name="startdate"></a>StartDate|The date when you want your campaign to begin serving. *Note*: Currently, this will only be honored for Audience campaigns.|**dateTime**|
