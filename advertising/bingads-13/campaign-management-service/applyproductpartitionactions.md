        ...
        <AdGroupCriterionAction>
          ...
          <AdGroupCriterion i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
            ...
            <Criterion i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
              ...
              <!--These fields are applicable if the derived type attribute is set to CustomLinkedInCriterion-->
              <Profile i:nil="false">ValueHere</Profile>
              <ProfileId>ValueHere</ProfileId>
              <ProfileType>ValueHere</ProfileType>
              ...
              <!--These fields are applicable if the derived type attribute is set to TopicCriterion-->
              <TopicId>ValueHere</TopicId>
              <TopicName i:nil="false">ValueHere</TopicName>
              <!--These fields are applicable if the derived type attribute is set to ChannelPlacementCriterion-->
              <ChannelId>ValueHere</ChannelId>
              <ChannelName i:nil="false">ValueHere</ChannelName>
              <ChannelPlacementId>ValueHere</ChannelPlacementId>
              <ChannelPlacementName i:nil="false">ValueHere</ChannelPlacementName>
              <SubChannelId i:nil="false">ValueHere</SubChannelId>
              <SubChannelName i:nil="false">ValueHere</SubChannelName>
            </Criterion>
