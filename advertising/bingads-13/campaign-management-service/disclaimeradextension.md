...
|<a name="title"></a>Title|The title of the popup in *popup* layout. *Note*: Title is not allowed in *additionalLine* layout.<br/><br/>The disclaimer title must be one of the following values: "Disclaimer info", "Disclaimer", "Disclosure", "More disclaimer info", "Offer Details", "Safety Info", or "Safety Information".|**string**|
