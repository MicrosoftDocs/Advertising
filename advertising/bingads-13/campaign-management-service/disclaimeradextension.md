...
|-----------|---------------|-------------|
|<a name="disclaimerlayout"></a>DisclaimerLayout|The layout in which you want the disclaimer to be displayed on your ad. The possibale values are AdditionalLine or Popup. This field is required|**string**|
...
|<a name="linetext"></a>LineText|The additional Line of thest that will show up with the ad. This is required if the DisclaimerLayout is AdditionalLine. Maximum length is 80 chartaters. If this field is set when the DisclaimerLayout is Popup, we will throw an error.|**string**|
|<a name="name"></a>Name| Name of the Disclaimer extension to help identify the adextension. This is not served with the ad. Required fields. Maximum lenagth fo this is 35 charatcters.|**string**|
|<a name="popuptext"></a>PopupText| The text in the popup that will show with the ad. This is required if the DisclaimerLayout is Popup. Maximum length is 500 chartaters. If this field is set when the DisclaimerLayout is AdditionalLine, we will throw an error.|**string**|
|<a name="title"></a>Title|The title of the popop what will show with the ad. This is required if the DisclaimerLayout is Popup. The supported values are "Disclaimer info", "Disclaimer", "Disclosure", "More disclaimer info", "Offer Details", "Safety Info", "Safety Information", "Info d'exclusion", "Exclusion de responsabilité", "Divulgation", "Autres informations d’exclusion de responsabilité", "Détails de l’offre", "Infos de sécurité", "Informations de sécurité", "Informationen zum Haftungsausschluss", "Haftungsausschluss", "Offenlegung", "Weitere Informationen zum Haftungsausschluss", "Angaben zum Angebot", "Sicherheitsinformationen", "Sicherheitsinformationen", "Informazioni dichiarazione di non responsabilità", "Dichiarazione di non responsabilità", "Divulgazione", "Ulteriori informazioni sulla dichiarazione di non responsabilità", "Dettagli dell'offerta", "Info sicurezza", "Informazioni di sicurezza", "Informações de aviso de isenção de responsabilidade", "Aviso de Isenção de Responsabilidade", "Divulgação", "Mais informações de aviso de isenção de responsabilidade", "Detalhes da Oferta", "Informações de Segurança", "Informações de Segurança", "Información de declinación de responsabilidades", "Aviso de declinación de responsabilidades", "Revelación", "Más información de avisos de declinación de responsabilidades", "Detalles de la oferta", "Inform. seguridad", "Información de seguridad", "免責聲明資訊", "免責聲明", "揭露", "更多免責聲明資訊", "優惠詳細內容", "安全資訊", "安全資訊" If this field is set when the DisclaimerLayout is AdditionalLine, we will throw an error.|**string**|
...
|<a name="type"></a>Type|The type of the ad extension. This value is *DisclaimerAdExtension* when you retrieve a filter link ad extension.<br/><br/>**Add:** Read-only<br/>**Update:** Read-only<br/><br/>For more information about ad extension types, see the [Ad Extension Data Object Remarks](adextension.md#remarks).|**string**|
