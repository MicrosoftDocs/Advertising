...
|<a name="operator"></a>Operator|The webpage condition operator.<br/><br/>**Add:** Required<br/>**Update:** Not applicable. You cannot update the webpage conditions. To update the conditions you must delete the criterion and add a new criterion.<br/><br/>**Default values** <br/><br/>**URL**  Contains, **Category** Equals, **PageTitle** Contains, **PageContent** Contains, **CustomLabel** Equals .<br/><br/>**Supported  values** <br/><br/>**URL**  Contains/Equals, **Category** Equals, **PageTitle** Contains, **PageContent** Contains, **CustomLabel** Equals|[WebpageConditionOperator](webpageconditionoperator.md)|
