...
```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/LabelAssociations/QueryByEntityIds
```

-----

## <a name="request"></a>Request Elements
The *GetLabelAssociationsByEntityIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
