---
title: AddDataExclusions Service Operation - Campaign Management
ms.service: bing-ads
...
description: Add a data exclusion to the specified account.
dev_langs: 
- csharp
- java
- php
- python
---
# AddDataExclusions Service Operation - Campaign Management
