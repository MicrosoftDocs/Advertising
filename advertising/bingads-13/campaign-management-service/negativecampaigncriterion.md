...
|<a name="criterion"></a>Criterion|The criterion to apply to the campaign. The criterion helps determine whether ads in the campaign are served.<br/><br/>For Performance Max campaigns, you can use [AudienceCriterion](audiencecriterion.md) to exclude an audience at the campaign level. You can also use [DeviceCriterion](devicecriterion.md) to exclude *Computers*, *Smartphones*, or *Tablets* at the campaign level. At least one device type must remain un-excluded.<br/><br/>For a list of available criterion types, see [CampaignCriterionType](campaigncriteriontype.md).<br/><br/>**Add:** Optional<br/>**Update:** Optional. If no value is set for the update, this setting is not changed.|[Criterion](criterion.md)|
