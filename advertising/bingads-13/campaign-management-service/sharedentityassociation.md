...
<xs:complexType name="SharedEntityAssociation" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:sequence>
    ...
    <xs:element minOccurs="0" name="IsExclusion" nillable="true" type="xs:boolean">
      <xs:annotation>
        <xs:appinfo>
...
The [SharedEntityAssociation](sharedentityassociation.md) object has the following elements: [EntityId](#entityid), [EntityType](#entitytype), [IsExclusion](#isexclusion), [SharedEntityCustomerId](#sharedentitycustomerid), [SharedEntityId](#sharedentityid), [SharedEntityType](#sharedentitytype), [Status](#status).
