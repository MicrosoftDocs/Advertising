---
title: AddCampaigns Service Test Operation - Campaign Management
ms.service: bing-ads
...
Below is an example that is applicable if the type of [BiddingScheme](biddingscheme.md) is [CommissionBiddingScheme](commissionbiddingscheme-test.md), [Setting](setting.md) is [CallToActionSetting](calltoactionsetting.md).
