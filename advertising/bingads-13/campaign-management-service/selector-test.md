  ...
  "Campaigns": [
    {
      ...
      "BiddingScheme": {
        "Type": "ValueHere",
        //"Comments": "These fields are applicable if the derived type attribute is set to CommissionBiddingScheme",
      ...
      "Settings": [
        {
          "Type": "ValueHere",
          //"Comments": "These fields are applicable if the derived type attribute is set to CallToActionSetting",
  ...
  "PartialErrors": [
    {
      ...
      "Message": "ValueHere",
      "Type": "ValueHere",
      //"Comments": "These fields are applicable if the derived type attribute is set to EditorialError",
