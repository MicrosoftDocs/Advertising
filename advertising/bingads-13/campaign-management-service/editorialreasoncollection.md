...
|<a name="appealstatus"></a>AppealStatus|A value that determines whether you can appeal the issues found by the editorial review. *Note*: *AppealStatus* is a combination of *Appealability* and *IsAppealPending*.|[AppealStatus](appealstatus.md)|
