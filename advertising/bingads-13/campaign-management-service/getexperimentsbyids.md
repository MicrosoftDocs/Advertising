...
|<a name="returnadditionalfields"></a>ReturnAdditionalFields|Return additional fields with the [Experiment](experiment.md) object.|[ExperimentAdditionalField](experimentadditionalfield.md)|
    ...
    <GetExperimentsByIdsResponse xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      <Experiments d4p1:nil="false" xmlns:d4p1="http://www.w3.org/2001/XMLSchema-instance">
        <Experiment>
          ...
          <ExperimentArms d4p1:nil="false">
            <ExperimentArm>
              <CampaignIds d4p1:nil="false" xmlns:a1="http://schemas.microsoft.com/2003/10/Serialization/Arrays">
                <a1:long>ValueHere</a1:long>
              </CampaignIds>
              <Id d4p1:nil="false">ValueHere</Id>
              <IsControlArm>ValueHere</IsControlArm>
              <TrafficSplit>ValueHere</TrafficSplit>
            </ExperimentArm>
          </ExperimentArms>
          <ExperimentCampaignId d4p1:nil="false">ValueHere</ExperimentCampaignId>
          <ExperimentCampaignType d4p1:nil="false">ValueHere</ExperimentCampaignType>
          <ExperimentStatus d4p1:nil="false">ValueHere</ExperimentStatus>
          <ExperimentSubType d4p1:nil="false">ValueHere</ExperimentSubType>
...
public async Task<GetExperimentsByIdsResponse> GetExperimentsByIdsAsync(
	...
	Paging pageInfo,
	ExperimentAdditionalField? returnAdditionalFields)
{
...
static GetExperimentsByIdsResponse getExperimentsByIds(
	...
	Paging pageInfo,
	ArrayList<ExperimentAdditionalField> returnAdditionalFields) throws RemoteException, Exception
{
...
```POST
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/Experiments/QueryByIds
```

# [Sandbox URL](#tab/sandbox)

```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/Experiments/QueryByIds
```

-----

## <a name="request"></a>Request Elements
The *GetExperimentsByIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetExperimentsByIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
