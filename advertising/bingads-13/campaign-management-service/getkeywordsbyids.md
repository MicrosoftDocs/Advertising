...
|<a name="assetgroupid"></a>AssetGroupId|The identifier of the adssetgroup whose keywords you want to get.|**long**|
...
<s:Envelope xmlns:i="http://www.w3.org/2001/XMLSchema-instance" xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <s:Body>
    <GetKeywordsByIdsRequest xmlns="https://bingads.microsoft.com/CampaignManagement/v13">
      ...
      <AssetGroupId i:nil="false">ValueHere</AssetGroupId>
...
static GetKeywordsByIdsResponse getKeywordsByIds(
	...
	ArrayList<KeywordAdditionalField> returnAdditionalFields,
	java.lang.Long assetGroupId) throws RemoteException, Exception
{
...
```POST
https://campaign.api.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByIds
```

# [Sandbox URL](#tab/sandbox)

```POST
https://campaign.api.sandbox.bingads.microsoft.com/CampaignManagement/v13/Keywords/QueryByIds
```

-----

## <a name="request"></a>Request Elements
The *GetKeywordsByIdsRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
## <a name="response"></a>Response Elements
The *GetKeywordsByIdsResponse* object defines the [body](#response-body) and [header](#response-header) elements of the service operation response. The elements are returned in the same order as shown in the [Response JSON](#response-json).
