...
|<a name="timeperiod"></a>TimePeriod|The time period of each report row. You may not include this column if the Aggregation element of the request object is set to Summary. For more information, see [Time Period Column](https://learn.microsoft.com/en-us/advertising/guides/reports?view=bingads-13#timeperiod).|
