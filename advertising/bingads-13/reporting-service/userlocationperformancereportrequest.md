...
You can request impressions, clicks, spend, and average cost-per-click for each ad group, organized by city, country/region, metro area (Nielsen DMA&reg; in the United States), radius, state, and account.
