---
title: AgeGenderAudienceReportFilter Data Object - Reporting
ms.service: bing-ads
...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Defines the criteria to use to filter the age and gender audience report data.
---
...
The [AgeGenderAudienceReportFilter](agegenderaudiencereportfilter.md) object has the following elements: [AccountStatus](#accountstatus), [AdDistribution](#addistribution), [AdGroupStatus](#adgroupstatus), [AssetGroupStatus](#assetgroupstatus), [CampaignStatus](#campaignstatus), [Language](#language).
