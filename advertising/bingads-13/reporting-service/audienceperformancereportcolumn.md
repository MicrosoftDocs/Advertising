...
|<a name="assetgroupid"></a>AssetGroupId|The asset group ID.|
...
|<a name="associationstatus"></a>AssociationStatus|The status of the association between the audience and either an ad group or campaign.<br/><br/>The possible values are *Enabled*, *Paused*, and *Excluded*.|
