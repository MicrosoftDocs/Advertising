---
title: BidStrategyReportRequest Data Object - Reporting
ms.service: bing-ads
...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Defines a bid strategy report request.
---
# BidStrategyReportRequest Data Object - Reporting
...
```xml
<xs:complexType name="BidStrategyReportRequest" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexContent mixed="false">
    <xs:extension base="tns:ReportRequest">
      <xs:sequence>
        <xs:element name="Aggregation" type="tns:ReportAggregation" />
        <xs:element name="Columns" nillable="true" type="tns:ArrayOfBidStrategyReportColumn" />
        <xs:element minOccurs="0" name="Filter" nillable="true" type="tns:BidStrategyReportFilter" />
...
The [BidStrategyReportRequest](bidstrategyreportrequest.md) object has the following elements: [Aggregation](#aggregation), [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
...
|<a name="columns"></a>Columns|The list of attributes and performance statistics to include in the report. The report will include the columns in the order that you specify them.|[BidStrategyReportColumn](bidstrategyreportcolumn.md) array|
|<a name="filter"></a>Filter|The filter information to use to filter the report data.|[BidStrategyReportFilter](bidstrategyreportfilter.md)|
|<a name="scope"></a>Scope|The entity scope of the report.<br/><br/>Use this element to limit the report data to specific accounts, ad groups, or campaigns.|[AccountThroughCampaignReportScope](accountthroughcampaignreportscope.md)|
...
The [BidStrategyReportRequest](bidstrategyreportrequest.md) object has [Inherited Elements](#inheritedelements).

## <a name="inheritedelements"></a>Inherited Elements

### <a name="inheritedelementsreportrequest"></a>Inherited Elements from ReportRequest
The [BidStrategyReportRequest](bidstrategyreportrequest.md) object derives from the [ReportRequest](reportrequest.md) object, and inherits the following elements: [ExcludeColumnHeaders](#excludecolumnheaders), [ExcludeReportFooter](#excludereportfooter), [ExcludeReportHeader](#excludereportheader), [Format](#format), [FormatVersion](#formatversion), [ReportName](#reportname), [ReturnOnlyCompleteData](#returnonlycompletedata). The descriptions below are specific to [BidStrategyReportRequest](bidstrategyreportrequest.md), and might not apply to other objects that inherit the same elements from the [ReportRequest](reportrequest.md) object.  
