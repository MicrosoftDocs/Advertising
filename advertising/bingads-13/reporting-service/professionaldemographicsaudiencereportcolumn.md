...
<xs:simpleType name="ProfessionalDemographicsAudienceReportColumn" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:restriction base="xs:string">
    ...
    <xs:enumeration value="LinkedInSegmentName" />
    <xs:enumeration value="LinkedInSegmentId" />
    <xs:enumeration value="LinkedInSegmentType" />
...
The [ProfessionalDemographicsAudienceReportColumn](professionaldemographicsaudiencereportcolumn.md) value set has the following values: [AbsoluteTopImpressionRatePercent](#absolutetopimpressionratepercent), [AccountId](#accountid), [AccountName](#accountname), [AccountNumber](#accountnumber), [AccountStatus](#accountstatus), [AdDistribution](#addistribution), [AdGroupId](#adgroupid), [AdGroupName](#adgroupname), [AdGroupStatus](#adgroupstatus), [AllConversions](#allconversions), [AllConversionsQualified](#allconversionsqualified), [AllRevenue](#allrevenue), [AssetGroupId](#assetgroupid), [AssetGroupName](#assetgroupname), [AssetGroupStatus](#assetgroupstatus), [Assists](#assists), [AveragePosition](#averageposition), [CampaignId](#campaignid), [CampaignName](#campaignname), [CampaignStatus](#campaignstatus), [CampaignType](#campaigntype), [Channel](#channel), [Clicks](#clicks), [CompanyName](#companyname), [Conversions](#conversions), [ConversionsQualified](#conversionsqualified), [CustomLinkedInName](#customlinkedinname), [Goal](#goal), [GoalType](#goaltype), [Impressions](#impressions), [IndustryName](#industryname), [JobFunctionName](#jobfunctionname), [JobSeniorityName](#jobseniorityname), [Language](#language), [LinkedInSegmentId](#linkedinsegmentid), [LinkedInSegmentName](#linkedinsegmentname), [LinkedInSegmentType](#linkedinsegmenttype), [MarketingObjective](#marketingobjective), [Revenue](#revenue), [Spend](#spend), [SubChannel](#subchannel), [TimePeriod](#timeperiod), [TopImpressionRatePercent](#topimpressionratepercent), [ViewThroughConversions](#viewthroughconversions), [ViewThroughConversionsQualified](#viewthroughconversionsqualified), [ViewThroughRevenue](#viewthroughrevenue).
...
|<a name="customlinkedinname"></a>CustomLinkedInName|The custom LinkedIn name.|
...
|<a name="jobseniorityname"></a>JobSeniorityName|The name of the job seniority level (according to LinkedIn) of the person who viewed the ad.|
|<a name="language"></a>Language|This is The language of the publisher where the ad was shown.|
|<a name="linkedinsegmentid"></a>LinkedInSegmentId|The identifier of the LinkedIn profile segment.|
|<a name="linkedinsegmentname"></a>LinkedInSegmentName|The LinkedIn segment name.|
|<a name="linkedinsegmenttype"></a>LinkedInSegmentType|The LinkedIn segment type.|
