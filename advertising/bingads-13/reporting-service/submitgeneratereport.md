...
|Element|Description|Data Type|
|-----------|---------------|-------------|
|<a name="reportrequestid"></a>ReportRequestId|The identifier of the report request.<br/><br/>Use this identifier when calling the [PollGenerateReport](pollgeneratereport.md) to determine the status of the report request.<br/><br/>The identifier is valid for a maximum of one day. If you have not successfully downloaded the file within this period, it is removed from the download site and you will need to get a new report request identifier.<br/><br/>The string has a length up to 40 and can contain any character.|**string**|
  ...
  <s:Body>
    <SubmitGenerateReportRequest xmlns="https://bingads.microsoft.com/Reporting/v13">
      <ReportRequest i:nil="false" i:type="-- derived type specified here with the appropriate prefix --">
        ...
        <!--These fields are applicable if the derived type attribute is set to FeedItemPerformanceReportRequest-->
        <Aggregation>ValueHere</Aggregation>
        <Columns i:nil="false">
          <FeedItemPerformanceReportColumn>ValueHere</FeedItemPerformanceReportColumn>
        </Columns>
        <Filter i:nil="false">
        </Filter>
        <Scope i:nil="false">
        ...
        <!--These fields are applicable if the derived type attribute is set to TravelQueryInsightReportRequest-->
        <Columns i:nil="false">
          <TravelQueryInsightReportColumn>ValueHere</TravelQueryInsightReportColumn>
        </Columns>
        <Filter i:nil="false">
        </Filter>
        <Scope i:nil="false">
        ...
        <!--These fields are applicable if the derived type attribute is set to BidStrategyReportRequest-->
        <Aggregation>ValueHere</Aggregation>
        <Columns i:nil="false">
          <BidStrategyReportColumn>ValueHere</BidStrategyReportColumn>
        </Columns>
        <Filter i:nil="false">
        </Filter>
        <Scope i:nil="false">
        ...
        <!--These fields are applicable if the derived type attribute is set to MSClickIdPerformanceReportRequest-->
        <Aggregation>ValueHere</Aggregation>
        <Columns i:nil="false">
          <MSClickIdPerformanceReportColumn>ValueHere</MSClickIdPerformanceReportColumn>
        </Columns>
        <Filter i:nil="false">
        </Filter>
        <Scope i:nil="false">
        ...
        <!--These fields are applicable if the derived type attribute is set to MMMPerformanceReportRequest-->
        <Aggregation>ValueHere</Aggregation>
        <Columns i:nil="false">
          <MMMPerformanceReportColumn>ValueHere</MMMPerformanceReportColumn>
        </Columns>
        <Filter i:nil="false">
          <AccountStatus i:nil="false">ValueHere</AccountStatus>
          <AdDistribution i:nil="false">ValueHere</AdDistribution>
        ...
        <!--These fields are applicable if the derived type attribute is set to SearchTermLandingPageReportRequest-->
        <Aggregation>ValueHere</Aggregation>
        <Columns i:nil="false">
          <SearchTermLandingPageReportColumn>ValueHere</SearchTermLandingPageReportColumn>
        </Columns>
        <Filter i:nil="false">
          <AdType i:nil="false">ValueHere</AdType>
          <DeliveredMatchType i:nil="false">ValueHere</DeliveredMatchType>
...
```POST
https://reporting.api.sandbox.bingads.microsoft.com/Reporting/v13/GenerateReport/Submit
```

-----

## <a name="request"></a>Request Elements
The *SubmitGenerateReportRequest* object defines the [body](#request-body) and [header](#request-header) elements of the service operation request.
...
Below is an example that is applicable if the type of [ReportRequest](reportrequest.md) is [AccountPerformanceReportRequest](accountperformancereportrequest.md).
