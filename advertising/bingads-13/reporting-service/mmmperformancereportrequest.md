...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Defines an MMM performance report request.
---
# MMMPerformanceReportRequest Data Object - Reporting
Defines an MMM performance report request.
...
|<a name="columns"></a>Columns|The list of attributes and performance statistics to include in the report. The report will include the columns in the order that you specify them.|[MMMPerformanceReportColumn](mmmperformancereportcolumn.md) array|
|<a name="filter"></a>Filter|The filter information to use to filter the report data.|[MMMPerformanceReportFilter](mmmperformancereportfilter.md)|
