...
<xs:simpleType name="ProductDimensionPerformanceReportColumn" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:restriction base="xs:string">
    ...
    <xs:enumeration value="CollectionId" />
    <xs:enumeration value="FeedLabel" />
...
|<a name="collectionid"></a>CollectionId|The collection ID.|
