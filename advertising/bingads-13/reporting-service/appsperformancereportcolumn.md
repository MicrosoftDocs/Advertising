...
|<a name="viewthroughcostperconversion"></a>ViewThroughCostPerConversion|The cost per conversion that people make after they have seen your ad, even though they did not click the ad.|This attribute is available only with the [AppsPerformanceReportColumn value set](../reporting-service/appsperformancereportcolumn.md).|
|ViewThroughConversionRate|The number of ad views, divided by the number of impressions.|This attribute is available only with the [AppsPerformanceReportColumn value set](../reporting-service/appsperformancereportcolumn.md).|
