...
|<a name="columns"></a>Columns|The list of attributes and performance statistics to include in the report. The report will include the columns in the order that you specify them.|[SearchInsightPerformanceReportColumn](searchinsightperformancereportcolumn.md) array|
|<a name="filter"></a>Filter|The filter information to use to filter the report data.|[SearchInsightPerformanceReportFilter](searchinsightperformancereportfilter.md)|
