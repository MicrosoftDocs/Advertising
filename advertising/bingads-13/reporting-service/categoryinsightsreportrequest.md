---
title: CategoryInsightsReportRequest Data Object - Reporting
ms.service: bing-ads
...
ms.author: jonmeyers
ms.date: 11/13/2024
description: Defines a category insights report request.
---
...
```xml
<xs:complexType name="CategoryInsightsReportRequest" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:complexContent mixed="false">
    <xs:extension base="tns:ReportRequest">
      <xs:sequence>
        <xs:element name="Columns" nillable="true" type="tns:ArrayOfCategoryInsightsReportColumn" />
        <xs:element minOccurs="0" name="Filter" nillable="true" type="tns:CategoryInsightsReportFilter" />
...
```json
{
  ...
  "Type": "CategoryInsightsReportRequest",
  "Columns": [
    "ValueHere"
  ],
  "Filter": {
...
The [CategoryInsightsReportRequest](categoryinsightsreportrequest.md) object has the following elements: [Columns](#columns), [Filter](#filter), [Scope](#scope), [Time](#time).
