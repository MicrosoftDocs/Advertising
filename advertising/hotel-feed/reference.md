...
|category|Optional.<br />Data type is string.<br /><br/>A user-defined category that identifies the type of hotel. For example, extended stay, economy, or motel. The maximum character length is 200. |None
