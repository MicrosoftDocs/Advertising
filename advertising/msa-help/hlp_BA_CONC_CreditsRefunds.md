...
- **How long does it take to process a credit for invalid clicks?**
  ...
  > [!NOTE]
  > > [!NOTE]
  > > If there is a change in your billing setup (such as the addition of a new SAP ID), any credit for invalid clicks will be processed as a credit memo.
...
> [!NOTE]
> If you need a credit or debit memo, please [contact Support](https://go.microsoft.com/fwlink/?linkid=398371).
