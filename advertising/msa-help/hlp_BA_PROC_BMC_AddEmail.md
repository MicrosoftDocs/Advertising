...
1. In the table, under **Edit store**, select **Edit**.
1. In the **Contact details** section, choose your language preference and enter an email address. You can add multiple email addresses, as long as they're separated by semicolons.
1. Select **Submit**.
