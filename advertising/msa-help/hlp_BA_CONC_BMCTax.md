...
| --- | --- |
| **Australia** | ![Yes](media/Global_Icon_CheckMark.png) |
| **Germany** | ![Yes](media/Global_Icon_CheckMark.png) |
| **France** | ![Yes](media/Global_Icon_CheckMark.png) |
| **United Kingdom** | ![Yes](media/Global_Icon_CheckMark.png) |
| **United States** | ![No](media/Global_Icon_Xmark.png) |

For additional questions on taxes, [Contact_adCEnterSupport_embedded.md](Contact_adCEnterSupport_embedded.md).
