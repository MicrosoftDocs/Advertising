...
- **How to create labels**
  ...
  1. From the navigation menu on the left, select **Tools** > **Labels**.
  1. Select **Add label**.
...
- **How to apply labels**
  ...
  1. Select **Account summary** > **Management**.
  1. Select the checkbox next to the appropriate account.
  1. In the blue action bar, select **Labels**.
  1. Select the the checkbox next to the label that you want to apply.
  1. Select **Apply**.
  ...
  1. Select the checkbox next to the appropriate campaign, ad group, ad, or keyword.
  1. In the blue action bar, select **Labels**.
  1. Select the the checkbox next to the label that you want to apply.
  1. Select **Apply**.
...
- **View label data in the Dimensions tab**
    - Manager account level labels    
        - From the navigation menu on the left, select **Reporting** > **Template** > **Labels** > **Account**.
