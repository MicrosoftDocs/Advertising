...
> [!NOTE]
> When you delete an ad group, you're unable to restore that ad group. If you delete your campaign, you cannot restore it and all associated data and history will be lost. If you want to delete your campaign, select **Campaigns** > **Campaigns**. Then, select the checkbox next to the appropriate campaign > **Edit** > **Delete**.

The changes that can be undone are:

- **Campaigns:** Bidding scheme, Budget amount, Budget type, Conversion goal (added/deleted) Name, Status, Tracking template.
...
- **Find and undo changes**
  ...
  1. From the navigation menu on the left, hover over **Campaigns** and select **Change history**.
  ...
  1. To show changes made by a specific person in the summary table, select **Add filter** > **Changed by** and select the user you want.
  1. To show specific types of changes in the table, select **Add filter** > **Change type**, select the ones you want and then select **Apply**.
  ...
  > - There is no way to undo imports from uploaded files or from other platforms, such as Google Ads, Meta Ads, and Pinterest Ads.
