...
- **As an advertiser, can I opt out from my ads being shown in the Ad Library?**
  ...
  No. Pursuant to the EU Digital Services Act, all ads served on Bing in the EU must be publicly available in the Ad Library. Additionally, all [ad types](#what-ad-types-are-eligible-to-appear-in-the-ad-library) are eligible to appear in the Ad Library.

  <a id="can-certain-ads-or-information-about-ads-be-removed-or-redacted-from-the-ad-library"></a>
...
- **If I deactivated a Microsoft Advertising account(s) or deleted/paused a campaign(s), will the associated ads still be displayed in the Ad Library?**
  ...
  > [!NOTE]
  > If you enable a paused campaign after one year, all associated ads will appear in the Ad Library as new ads.

- **Are advertisers charged for any clicks when someone selects their ads while searching in the Ad Library?**

  If someone searching through the Ad Library selects an ad preview in the Ad Details page, they'll be redirected to the advertiser's [destination URL](hlp_BA_DEFN_DestinationURL.md). We won't charge advertisers for these clicks, as there's no referral link for advertisers to identify which traffic came from the Ad Library.

  <a id="what-ad-types-are-eligible-to-appear-in-the-ad-library"></a>

- **What ad types are eligible to appear in the Ad Library?**

  [App Install ads](hlp_BA_CONC_AppInstallAds.md), [Audience ads](hlp_BA_CONC_NativeAds.md), [Dynamic Search ads](hlp_BA_CONC_DynamicSearchAds.md), [Hotel Price ads](hlp_BA_CONC_HotelAds_Intro.md), [Multimedia ads](hlp_BA_CONC_MMA_Search.md), [Product ads](hlp_BA_CONC_AboutProductAds.md), [Responsive Search ads](hlp_BA_CONC_ResponsiveSearchAds.md), [text ads](hlp_BA_PROC_CreateEXTA.md), and [Vertical ads](hlp_BA_CONC_AboutVerticalAds.md) are eligible to appear in the Ad Library if they served were served on Bing through the Microsoft Advertising Network and received impressions in the EU/EEA. [Ad extensions](hlp_BA_CONC_AboutAdExtensions.md) are excluded.
...
- **Who can I contact if I have any questions?**
  ...
  Please [contact support](https://go.microsoft.com/fwlink/?linkid=398371) if you have further questions or need assistance.
...
- **I'm an advertiser and have questions about the ads or information shown in the Ad Library. Where can I find help?**
  ...
  To learn more about the Ad Library, see [About the Ad Library](#About).
...
- **Do ads that have been disapproved in one or more countries appear in the Ad Library?**
  ...
  If an ad has been approved in at least one EU/EEA member state, then it will appear in the Ad Library. Please note that approval status may vary by country. For more information about the editorial review process, see [The Editorial Review](hlp_BA_CONC_EditProcess.md) overview.
