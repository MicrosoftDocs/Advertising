...
- **Best practices for signing in to (Microsoft Advertising)**
  ...
  - **Identify yourself with a security code:** When you access sensitive Microsoft Advertising information or make changes (your password, for example), youâ€™ll be asked to enter a security code that has been sent to your phone or an email address. After you enter the code, you can access and manage your information.
...
- **Create strong passwords and keep them private**
  ...
  - Donâ€™t disclose passwords or PINs to coworkers.
...
- **Avoid phishing scams**
  ...
  :::image type="content" source="media/BA_Screencap_Certificate.png" alt-text="Example of a valid security &quot;root&quot; certificate verification.":::

- **Defend your computer**

  - Strengthen your computersâ€™ defenses:
    ...
    - Use flash drives carefully to minimize the chance that youâ€™ll infect your company network with malware.
    - Make sure all computers and devices are locked when they are left unattended.
  - Donâ€™t be tricked into downloading malicious software. Think carefully before you open attachments or click links in unusual email, instant messages (IM), or text messages on social networks or in random pop-up windows. If youâ€™re unsure if a message is legitimate, even if itâ€™s from a coworker, contact the sender, ideally using a different device and another account.

- **Protect company data and financial assets**

  - Donâ€™t put *confidential* information in email, instant messages, or text messages; they may not be secure.
