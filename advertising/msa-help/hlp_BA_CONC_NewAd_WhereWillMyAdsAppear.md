...
:::image type="content" source="media/BA_Conc_NewAdv_SERP.png" alt-text="Sample Bing ad on a Bing search results page.":::

## Show your ads on smartphones and tablets

Your ads can appear specifically for customers on the go, who use their smartphones and tablets to search and browse the Internet. Or you can create ads that appear on both computers and smartphones but prioritize where you want the ads to appear more often.

:::image type="content" source="media/BA_Conc_NewAdv_MobileAd.png" alt-text="Sample Bing ad on a smartphone search results page.":::
...
When you choose your ad language, you select your customers' language, which will influence where your ads will appear. For example, if Sarah selects German, her ads can appear not only to customers in Germany but Austria and Switzerland as well. [Learn more about how ad language and location targeting affect who can see your ads](hlp_BA_CONC_LocTargetAndLang.md)
