...
Control when your ad extensions will show to customers with ad extension scheduling. You can have them show on certain days or during certain hours, so you can best cater to your targeted customers. Note that although pausing ad extensions is not possible, you can use scheduling to manage when they should show. You can also disassociate extensions from campaigns where you no longer want them to serve.
