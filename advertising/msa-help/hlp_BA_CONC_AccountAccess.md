...
- **“You can't sign up here with a work or school email address. Use a personal email, such as Gmail or Yahoo!, or get a new Outlook email.”**
  ...
  - **How to fix:**
    ...
    - If you're still blocked, contact your IT administrator to add you as an authorized user. Share [this link](https://learn.microsoft.com/en-us/entra/identity/enterprise-apps/configure-user-consent?tabs=azure-portal&pivots=portal) for reference.
