...
[Go to keyword planner](https://go.microsoft.com/fwlink/?linkid=2223558). (When you select the link, you will need to sign in to Microsoft Advertising if you aren't currently signed in.)
...
- **Find new keywords**
  ...
  **Search for new keywords**
  ...
  1. From the navigation menu on the left, select **Tools** > **Keywords**.
  1. Select **Search for new keywords using a phrase, website, or category**.
  ...
  1. Optional: Enter targeting information.<br><br> This will impact keyword suggestions, historical statistics, and traffic estimates. For more information, select the question mark (**?**) next to **Targeting** in keyword planner.
  1. Optional: Enter negative keywords, separated by commas.<br><br>Words you enter here will not be included in keywords that are suggested to you.
  1. Optional: Set date range. <br><br> You can set the start and end months to get the search volume trends and data for the specified time range.
...
- **Plan your budget and get insights for keywords**
  ...
  **Get search volume data and trends**
  ...
  1. From the navigation menu on the left, select **Tools** > **Keywords**.
  1. Select **Get search volume data and trends**.
  1. Enter keywords manually in **Option 1: Enter keywords** or upload a .csv or text file in **Option 2** by selecting **Choose file...**.
  1. Optional: Enter targeting information. <br> This will impact keyword suggestions, historical statistics, and traffic estimates. For more information, select the question mark (?) next to **Targeting**.
  1. Select **Get search volume**.
  ...
  **Get performance and cost estimates**
  ...
  1. From the navigation menu on the left, select **Tools** > **Keywords**.
  1. Select **Get performance and cost estimates**.
  1. Enter keywords manually in **Option 1: Enter keywords** or upload a .csv or text file in **Option 2** by selecting **Choose file...**.
  1. Optional: Enter targeting information.<br> This will impact keyword suggestions, historical statistics, and traffic estimates. For more information, select the question mark (?) next to **Targeting**.
  1. Select **Get estimates**.

  You'll be presented with a bid landscape for all of your keywords. To get detailed estimates in the table, enter a bid in the box above the graph or hover and select any point directly on the graph to choose a bid. To see estimates for a specific bid and budget, enter both a bid and a daily budget.

  To change one of your bids, select the bid amount under "Max. CPC" in the table, enter your new bid, and select **Save**. If your keywords have different bid amounts, the graph will show the estimated number of clicks you'll get for each bid percentage change. To adjust all your bids by the same percentage, hover and select the desired percentage directly in the graph.

  After reviewing the recommended ad group and keywords, you can select the **Save to account** button on the upper right corner to directly save to your account by creating a new campaign or adding to an existing campaign.
