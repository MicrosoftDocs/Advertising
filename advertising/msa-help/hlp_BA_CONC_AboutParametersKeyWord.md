...
| --- | --- |
| `{KeyWord}` or `{KEYWORD}` | Capitalizes the first letter of each word in the keyword |
...
| Placeholder | What it does |
| --- | --- |
| `{keyword}` | Changes the first letter of each word to lowercase |
...
| Placeholder | What it does |
| --- | --- |
| `{Keyword}` | Capitalizes the first letter of the first word in the keyword |
...
| Placeholder | What it does |
| --- | --- |
| `{KeyWORD}` | Capitalizes the first letter of the first word and all the letters of the last word in the keyword |
...
| Placeholder | What it does |
| --- | --- |
| `{KEYWord}` | Capitalizes all the letters of the first word in the keyword and first letter in the second word |
