...
> [!TIP]
> [New to Microsoft Shopping campaigns? Learn how to get started in this training course.](https://go.microsoft.com/fwlink/?linkid=2129851)
...
1. Select the store name > select the **Feeds** tab.
1. Select **Create feed**.
1. Select **Automatically download file from URL** under **Input method**.
1. Enter the **Source URL**. For example, https://www.contoso.com/feeds/bingmerchant.txt.
1. If required, enter the **User name** and **Password**.
1. Choose the **Frequency** under **Download schedule**: Either **Daily**, **Weekly**, or **Monthly**. Select the remainder of your scheduling preferences.
1. Select **Create feed**.
