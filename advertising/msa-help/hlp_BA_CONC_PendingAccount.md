...
- If you're an established Microsoft Advertising customer who has previously run ads and now have your account in pending status, then you need to [add a payment method](hlp_BA_PROC_AddBilling.md). Once you add a payment method, your account will become active.
