...
Due to character limit restrictions, not all action types are available per supported language. Check out the full list of action types [here](https://aka.ms/ads/ActionExtensionsText2025).
