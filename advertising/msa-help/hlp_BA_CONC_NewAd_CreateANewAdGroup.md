...
1. Select **Create**.
1. Choose which campaign you want to create the ad group in.
1. Select **Continue**.
...
### **Create a Standard ad group**
  ...
  2. Keywords: In the second step, you add the relevant keywords and phrases to reach customers who are searching for your product or service. Your ads will show in response to search queries based on the keywords you provide. [Learn more about keywords and how to build keyword lists](hlp_BA_CONC_AboutKW.md)
  ...
  3. Create ads: In the third step, you create the ad(s) for your ad group.
  ...
  4. Targets & bids: In the fourth step, you set your bids and adjust your targets and advanced ad group settings.
...
1. The ad group creation wizard will then walk you through the next steps in the process:
...
- **Choose your audience and targeting settings**
  ...
  - **Predictive targeting**: After you set your targeting preferences, you can choose to enable or disable Predictive targeting. Predictive targeting helps you easily find new audiences that you may not have considered targeting, who are more likely to convert. For more information, see [Predictive targeting](hlp_BA_CONC_PredictiveTargeting.md). Once you submit your criteria, select **Save & go to next step**.
...
1. Select **Ad groups** from the side menu.
1. Select the ad group you want to edit.
1. Select **Settings** from the side menu.
1. Below **Ad rotation** within your Advanced ad group settings, choose **Optimize - prioritize ads that perform well** or **Rotate ads more evenly - include all ads, even those with a lower CTR**.
1. Select **Save**.
