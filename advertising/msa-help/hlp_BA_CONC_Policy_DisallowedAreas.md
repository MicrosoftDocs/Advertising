---
title: Areas of questionable legality
ms.service: msa-help
...
To ensure that all advertisements comply with legal standards and maintain high standards of ethical advertising practices, Microsoft strictly prohibits advertising for illegal products, content, and services. Examples include, but are not limited to, counterfeit goods, unlicensed pharmaceuticals, and unauthorized streaming services.

Additionally, Microsoft reserves the right to refuse advertisements for content, products, and services if their legality or regulatory status is ambiguous.

### Compliance with Legal Orders:

Microsoft will remove ads and advertisers from serving on our network in response to valid orders from government or regulatory agencies addressing illegal content.
