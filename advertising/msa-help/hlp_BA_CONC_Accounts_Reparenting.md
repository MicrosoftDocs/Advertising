...
- **Is the feature right for you?**
  ...
  - Fixing sub-optimal set-ups where the client account was created within the agency account. Ideally, the client would create their own individual shell and link it to the agency account.
  ...
  > - Accounts that have set up lodging campaigns, Shopping campaigns, Search campaigns with shopping settings enabled, or flyer extensions with associated store can't be transferred.
...
- **What items transfer over**
  ...
  When you transfer an account to a new owner, the following information will automatically be transferred:

  - Account fundamentals (e.g., account ID/number/name, account/billing language, account time zone and business location, tax ID, auto-tagging, previous billing documents, and account level pilots)
  - All existing campaign data (e.g., ads, ad groups, ad extensions, campaign settings and campaign change history, keywords, historical campaign performance data and reports), including uninterrupted campaign and ad delivery
  - Billing (e.g., who pays, payment options)
  - Linking relationships
  - Scheduled tasks (e.g., automated rules, scripts, scheduled reports)
  - User management (e.g., user account access and primary user allocation)
