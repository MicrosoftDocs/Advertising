...
> [!IMPORTANT]
> All extension details must adhere to our [promotion extension policies](TODO-FWLINK-2271152).
...
- Your promotion extension's **Displayed start date - Displayed end date** should ideally match your scheduled **Start date** and **End date**. <br>

  > [!NOTE]
  > If the displayed date range falls outside the scheduled **Start date** and **End date**, your promotion extension will still serve during the **Start date** and **End date**.
- If your **Displayed end date** is set before the current date, then the displayed date range will not appear in your promotion extension.
- Promotions can still serve before the **Displayed start date**. For example, you can provide customers with a promotion code for an upcoming sale.
...
## View your promotion extension in the account level shared library
...
1. Select the **Account** tab to locate the specific extension you want to review.
