...
Sitelink extensions are additional links in your ads that take people to specific pages on your website. For each campaign, you can enter up to 20 sitelinks. By default, the sitelinks are set at the campaign level, however, you can also set sitelinks at the ad group level. Sitelinks are eligible to serve for an ad at any level (ad group, campaign, and account). With sitelinks you can:
...
:::image type="content" source="media/BA_CONC_SitelinkExtension.png" alt-text="Sitelink extensions.":::
...
An ad can display two to eight sitelinks or dynamic sitelinks with descriptions, or two to six sitelinks in a single row without descriptions, which will be determined by Microsoft Advertising. When displaying an ad, Microsoft Advertising determines which links are most relevant to the ad being displayed and includes those with your ad. Learn more about [sitelink extensions policies](hlp_BA_CONC_Policy_AdExtensionPolicies.md).
...
- [Watch the video](https://www.youtube.com/watch?v=nBl_BGGa5bQ)
