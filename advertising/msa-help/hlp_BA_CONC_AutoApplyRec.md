...
### Benefits of opting in to auto-apply recommendations

- Increases impression shares (based on Microsoft Advertising internal data).
- Boosts search volume and removes conflicting keywords.
- Improves conversion tracking on your websites and increases conversion data (based on Microsoft Advertising internal data).
...
- **Opt out of auto-apply recommendations**
  ...
  1. From the navigation menu on the left, hover over **Campaigns** and select **Recommendations**.
  1. Select the **Auto-apply recommendation setting** (lightning bolt icon).
  1. Clear the checkbox next to the recommendation type you would like to opt out of auto-apply for.
  1. Select **Save**.
...
You can track which recommendations were adopted in the **Account Change history** tab or the **My applied recommendation history** page within the **Recommendations** tab. From the **Change history** tab, filter the records by setting the value of the **Change by** attribute to *Recommendations auto apply*. You can then read the applied history up to the most recent six months. On the **My applied recommendation history** page, you can read how many recommendations have been in applied in the past 30 days.

You can also track the auto-applied ads performance from the **Ads & extensions** tab. Add the **Automated ad** column to the ads grid view, and then filter out the rows by setting its value to *Yes*. You will now see all the recommended ads that were auto applied.
