...
- **1. Campaign settings**
  ...
  - **Campaign budget**
    ...
    > [!NOTE]
    > If you have AI Max enabled, you'll set up your campaign budget in the fifth step belowâ€”see the **Budget & bids** dropdown.
  ...
  - **Autogenerated assets**
    ...
    > [!NOTE]
    > If you have AI Max enabled, you'll set up your optimized assets in the second step belowâ€”see the **AI Max** dropdown.
