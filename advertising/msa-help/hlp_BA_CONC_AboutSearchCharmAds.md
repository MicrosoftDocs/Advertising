...
> [!NOTE]
> Learn more about where [Microsoft Advertising in Bing Smart Search is available](hlp_BA_CONC_Countries.md).

Pay-per-click Search ads created in Microsoft Advertising can be displayed in the Bing Smart Search results.

:::image type="content" source="media/BA_Conc_SmartSearchExample.png" alt-text="Sample Bing Smart Search ads.":::

Bing Smart Search ads are similar to other Search ads, but formatted for the modern touch experience. For example, when possible, the Bing Smart Search ads will include a preview of your landing page as shown above.
