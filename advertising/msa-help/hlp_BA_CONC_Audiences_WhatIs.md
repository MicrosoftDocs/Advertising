...
- **Try different campaign types**: Audience targeting works across all campaign types, including [Microsoft Shopping campaigns](hlp_BA_CONC_BSC_GetStarted.md), [Audience campaigns](hlp_BA_CONC_NativeAds.md), [Dynamic Search ad campaigns](hlp_BA_CONC_DynamicSearchAds.md), and [Lodging campaigns](hlp_BA_CONC_HotelCampaigns.md).
