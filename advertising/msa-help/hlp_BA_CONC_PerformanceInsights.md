...
When a significant change in your account performance is detected, we automatically set out to figure out what happened and why. When we figure it out, we'll add a ![light bulb icon](media/Global_Icon_Info.png) under the performance trend graph. Each Performance Insight contains three sections:
