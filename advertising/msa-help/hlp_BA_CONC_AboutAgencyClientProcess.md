...
- **Accept or decline an agency request**
  ...
  Only a user with Super Admin permissions can accept or decline a linking request. For more information about managing linked accounts, see [Linking to an existing account](hlp_BA_CONC_MultiAccount.md).
...
- **Stop an agency from managing your account**
  ...
  1. Enter the **Date**. This is the date you want to stop managing the account. You can also select **Immediately**.
  1. Select **Unlink accounts**.

- **Find your account number**

  1. In the upper left-hand corner, select the **Manager account** to view all account names and corresponding account numbers in the drop-down menu.

  OR

  1. From the navigation menu on the left, select **Tools** > **All accounts**.
  1. Under **Accounts summary**> **Performance**, account numbers are located next to their corresponding account names in the **Account name** column.
