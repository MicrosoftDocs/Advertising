...
- **Manage alerts in the Notifications table**
  ...
  1. At the top of the table, select **Add filter**.
  1. Select the column you want to filter and refine the filter criteria.
  1. Give your filter a name if you expect to use this same filter combination frequently.
  1. Select **Apply**.
  1. To narrow the filter further, select **Add filter** and select more options from the list boxes provided.
  1. Select **Apply** to filter the table.
  1. To change how the table is filtered, select **Edit** at the top of the table, or select **Reset** to clear all filtering.
