...
Most reviews are completed within 48 hours. The editorial status for most of your ad components can be found in the **Delivery** column of the **Ads**, **Keywords**, or **Ad Extensions** table, or in **Tools** > **Business data**. However, to view the editorial status for your assets, follow these steps:
...
- **Native ads and Responsive Search ads**
  ...
  If the review results in a disapproved ad or ad component, see [Fix a Disapproved or Approved Limited status](hlp_BA_CONC_EditorialDisapprovalReasons.md)
  ...
  > - Most reviews are completed within 48 hours. If your content still has the **Pending editorial review** delivery status after two business days, please [contact Support](https://go.microsoft.com/fwlink/?linkid=398371) for assistance.
