...
> [!NOTE]
> Recently migrated from Microsoft Invest (powered by Xandr) and need help with Invest-related resources? You can still access their [Help Center](https://learn.microsoft.com/en-us/xandr/invest/) for additional support.
...
> [!NOTE]
> By default, the SAP credit line is displayed in USD. However, billing is processed in the currency selected for your account, and all generated invoices will reflect that designated currency. If the account currency differs from the SAP credit line currency, the bank will perform the necessary conversion. For monthly invoicing accounts, payments are made in the account's designated currency, and the bank will convert the amount to the selected currency as required.
...
To receive your Boleto to pay a monthly invoice, [please go here.](hlp_BA_PROC_Boleto.md)
...
Depending on your business location, you can pay for your invoice by wire transfer or ACH. You can find the remittance instructions on your invoice for the specific ways you can pay, the due date (net terms), and the specific customer service contact if you have questions.

### Important:

To speed up payment processing, you must include your invoice number and account number with your payment. Without this information, payment processing time can be greatly increased beyond our typical 5 days.

## How do I edit my payment method when paying by invoice?

If you want to update the bill-to information such as company address, go to **Billing** > **Payment methods** and then select **Manage credit settings** for the SAP ID you're using. Follow the process and submit the changes. Once the changes are approved, it will show on your next monthly invoice.

To modify a payment method for an existing monthly invoice, please contact [Support](https://go.microsoft.com/fwlink/?linkid=398371) to credit and rebill an invoice once you've updated the bill-to information by managing credit settings on the **Payment methods** page by following the steps mentioned above.
...
Yes. If you decide you do not want to continue with monthly invoice payment and want to switch to postpay threshold or prepay, then please contact your Account Manager or [Support](https://go.microsoft.com/fwlink/?linkid=398371).

## Who do I reach out to with questions or concerns about my monthly invoice?

If you have any questions regarding invoices or payments that have been processed, please refer to the regional customer service contact listed on the bottom left of your invoice. If you need further assistance, contact [Support](https://go.microsoft.com/fwlink/?linkid=398371).
