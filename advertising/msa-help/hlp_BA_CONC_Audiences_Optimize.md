...
- **Set a specific bid amount**
  ...
  1. Select **Increase by** or **Decrease by** and enter the amount in percent.<br> You can increase the bid up to 900% and decrease by 90%.
...
- **Customize ads to your specific audience**
  ...
  1. Select **Create** and enter an ad that uses words that are of interest to your audience. <br> For example, you can create an ad that says "40% off Colombian blend."
  1. Add final URL to a specific page on your website. <br> For example, link to the Colombian blend webpage.
  1. From the navigation menu on the left, hover over **Campaigns** and select **Audiences**.
