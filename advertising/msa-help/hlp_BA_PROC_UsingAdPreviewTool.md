...
1. From the navigation menu on the left, select **Tools** > **Ad preview & diagnostics**.
1. On the **Ad Preview and Diagnostics Tool** page, type the keyword or search query for which you want to find Search ads.
1. Select the targeting options (**Language**, **Location**, and **Device**) for which you want to preview your ads.
1. Select **Preview**.
1. If you see any of these messages, take the steps below:
...
> - The Ad preview and diagnostics tool currently supports Responsive search ads and Product ads. Currently, the Ad preview and diagnostics tool does not support Dynamic Search ads.
> - The Ad preview and diagnostics tool only applies to ad delivery on bing.com at this time, not yahoo.com or any syndicated properties.
> - Ad extensions will not appear with your ads when using the Ad preview tool.
