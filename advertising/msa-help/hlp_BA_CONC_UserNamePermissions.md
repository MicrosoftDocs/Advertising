...
You can view the accounts you have access to along with the related user roles from the **Manage my user access** page, which is accessible when you select the profile picture in the upper-right corner of any Microsoft Advertising page.
...
- **Switching from one manager account to another to view different accounts**
  ...
  1. If you have multiple accounts, choose one from the account dropdown menu on the top left.
  1. You can select to view the default manager account, which will always be at the top of the list. You can also select frequently accessed manager accounts, which will be displayed under **Recent**. Or, you can select **View all** to see the full list of manager accounts. There, you can select an individual manager account's tile to see its related ad accounts.
...
- **Setting a default manager account**
  ...
  1. If you have multiple accounts, choose one from the account dropdown menu on the top left.
  1. Select **Manage my user access**.
  1. Select **Set as default** under **Action** for the manager account that you to see immediately upon signing in to Microsoft Advertising.
...
- **Managing notifications settings**
  ...
  1. If you have multiple accounts, choose one from the account dropdown menu on the top left.
  1. Select **Manage my user access**.
  1. Select **View email preferences** under **Action** for the manager accounts that you want to modify.
  1. Under **Set account email preferences for my account(s)**, you can specify the types of alerts you'd like to receive for this manager account.

- **Removing access**

  1. If you have multiple accounts, choose one from the account dropdown menu on the top left.
  1. Select **Manage my user access**.
  1. Select **Delete access** under **Action** for the manager account you no longer need access to.
