...
1. From the navigation menu on the left, select **Tools** > **Bids & budgets** > **Shared budgets**.
...
> [!NOTE]
> Performance Max and Premium Streaming campaigns don't support a shared budget yet.
...
## Change a shared budget to a non-shared budget

1. From the navigation menu on the left, select **Tools** > **Bids & budgets** > **Shared budgets**.
1. From the collapsible menu on the left, select **All campaigns** > **Overview** > **Settings**.
1. Select the name of the campaign you want to edit to open its settings.
1. Select **Individual budget** from the**Campaign budget**list.
1. Set the daily budget amount.
1. Select **Save**.
