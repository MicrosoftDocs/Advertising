...
> [!NOTE]
> Predictive targeting is available for Audience campaigns, while [predictive matching](hlp_BA_CONC_MatchOptions.md) is available for Search campaigns.

## Use predictive targeting with all audience targeting solutions
...
- **Set up predictive targeting during ad group creation**
  ...
  1. During step 1 of ad group creation, expand **Targeting preferences (optional)**.
  1. Turn on the **Use predictive targeting** toggle.
...
- **Change the setting of existing ad groups**
  ...
  1. Select **Settings**.
  1. Expand **Predictive targeting**.
  1. Turn on or turn off the **Use predictive targeting** toggle.
  1. Select **Save**.

## Frequently asked questions

- **What signals are used to determine who my ad is served to?**
...
- **Do I need UET to use predictive targeting?**

  UET is not required, but it is recommended and can help to improve performance.

- **Can I use predictive targeting with my other audiences? (i.e., remarketing, similar audiences, in-market audiences, etc.)**
...
- **Is there reporting available to show who my ads were served to and on which sites?**
...
- **What kind of performance can I expect from using predictive targeting?**

  You can expect performance similar to or better than what you currently see from campaigns targeting in-market audiences.

- **Can I use predictive targeting for all campaign types?**

  Predictive targeting is currently only available for Audience campaign ad types (Display, Native, and Online Video ads).

- **I have bid-boosts on high performing audiences already. Will these be prioritized over predictive targeting?**
...
- **Can I turn off predictive targeting?**
  ...
  Predictive targeting will be switched on by default in new ad groups, but you can turn it off in ad group settings if targeting is selected. There is no change to existing ad groups.

- **Why would I use predictive targeting instead of in-market audiences?**
...
- **Will predictive targeting work with customer match?**

  Yes. Predictive targeting will work with customer match.

- **Is this like similar audiences?**
...
- **I currently use a tool provider. Will predictive targeting have any impact?**

  Predictive targeting will not have API impact at pilot. API functionality will be available in a future release.

- **Is this targeting option available on other advertising platforms?**

  Yes. Predictive targeting is available on other advertising platforms. Google calls this optimized targeting.

- **If predictive targeting is already used for in-market audiences, what is the real impact of this feature?**
...
- [Predictive targeting for Audience ads](https://www.youtube.com/watch?v=iN-hIrAAr1w)
