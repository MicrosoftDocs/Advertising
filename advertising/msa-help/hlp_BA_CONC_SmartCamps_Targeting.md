...
- **Editing your business category, products, services, or language**
  ...
  1. In the **Keyword themes** pane, select **Edit**.
  1. Update your settings.

     As you add keyword themes, pay attention to the **Estimated number of potential customers** window on the right. This shows you how many people we estimate will search on the Microsoft Advertising Network for these keyword themes (within the locations you are targeting) each month.
  1. Select **Save**.
...
- **Editing the geographic location you want to advertise in**
  ...
  1. From the navigation menu on the left, hover over **Campaigns** and select **Campaigns** > **Campaign details** for the campaign you want to edit.
  1. In the **Locations** pane, select **Edit locations**.
  1. Update your settings.

     As you adjust the radius or add locations, pay attention to the **Estimated number of potential customers** window on the right. This shows you how many people we estimate will search for your keyword themes within these locations on the Microsoft Advertising Network each month.
  1. Select **Save**.
