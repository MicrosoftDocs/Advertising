...
1. From the navigation menu on the left, select **Tools** > **Bulk actions** > **Automated rules**.
1. Select the checkbox next to the rules you want to change.
1. Select **Change status** > **Enable**, **Pause**, or **Delete**.

To edit an existing rule:

1. From the navigation menu on the left, select **Tools** > **Bulk actions** > **Automated rules**.
1. In the **Action** column (on the right side of the page), select **Edit rule**.
...
> - Automated rules in Microsoft Advertising take effect in less than 1 hour after being set. These times may vary depending on external factors (such as server maintenance or tool upgrades).
