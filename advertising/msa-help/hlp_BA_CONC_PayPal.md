...
- **Adding a PayPal account as a payment method**
  ...
  1. Select **Add PayPal**.
  1. Enter a billing address if you're prompted to do so. Otherwise, select **Next** to be directed to the PayPal site.
  1. If you already have a PayPal account, sign in. If you do not have a PayPal account, sign up for a PayPal account.
  1. After you've signed in to your PayPal account, review and agree to the Microsoft Advertising billing agreement. You will be redirected back to Microsoft Advertising.
  1. In **Payment Methods**, select **Add funds** and follow the instructions to add a prepay amount.

- **Updating your PayPal account's friendly name or address**
  These instructions only apply to PayPal accounts that were added to Microsoft Advertising before November 2017. Now, Microsoft Advertising no longer requires a friendly name or an address to add a PayPal account as a payment method.
  1. From the navigation menu on the left, hover over Billing and select Payment methods.
  1. Next to the PayPal account you want to update, select Edit.
...
> - Signing up for a PayPal account is subject to the PayPal [User Agreement](https://www.paypal.com/us/cgi-bin/webscr?cmd=p/gen/ua/ua_pop-outside&popup=23) and [Privacy Policy](https://www.paypal.com/us/cgi-bin/webscr?cmd=p/gen/ua/policy_privacy_pop-outside&popup=23) outlined on the PayPal site.
> - If you want to remove a PayPal account completely from Microsoft Advertising, you'll need to make sure that the PayPal account is not a primary payment method for any of your Microsoft Advertising accounts. (For instructions on how to delete a payment method, see [Deleting a payment method](hlp_BA_PROC_DeleteCard.md).) Then you can go to the PayPal website and delete the Microsoft Advertising account from there.
