...
:::image type="content" source="media/BA_Conc_UurlAnimated.gif" alt-text="Show destination URL and then final URL and tracking template.":::

*To replay animation, in your browser, select Refresh or Reload.*
...
- **Import from Google Ads in either Microsoft Advertising or Microsoft Advertising Editor**
  ...
  1. Enter your Google sign-in information, select **Sign in** and then **Accept**.
  1. Select the Google Ads campaigns you want to import, then select **Continue**.
