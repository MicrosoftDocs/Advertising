...
1. Select the name of the uploaded feed file you want to generate a report for.
1. Above the table, select **Columns** > **Modify columns**. <br>

   :::image type="content" source="media/BA_CONC_Feeds_Reporting.png" alt-text="Select column and then Modify column.":::
1. Select **Add** for any performance metrics you'd like to measure. <br>

   :::image type="content" source="media/BA_CONC_Feeds_Reporting_2.png" alt-text="Modify columns options.":::
1. Select **Apply** to see the performance metrics in the table.
