...
Microsoft has partnered with Shutterstock to provide you with quality images you can use in your ads for free. You can use up to 1000 stock images.
...
- **Accepted file types for images:** JPEG, JPG, PNG, and GIF (without animation).
- **1.91 : 1 aspect ratio** is required for the extension to be eligible to serve on the Microsoft Advertising Network.
...
## Image requirements for Audience ads

For more information about image requirements for Audience ads, see [Best practices for Audience ad images](hlp_BA_CONC_ImagesForAudienceAds.md).

## Microsoft Advertising image policies
To learn more about Microsoft Advertising's image policies, visit [Creative Specs](https://help.ads.microsoft.com/#apex/ads/en/60207/0) and [General Ad Requirements](https://help.ads.microsoft.com/#apex/ads/en/60209/0)
