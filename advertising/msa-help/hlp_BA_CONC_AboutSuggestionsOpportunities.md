...
- **Use Keyword suggestions to update your keyword list**
  ...
  1. If Microsoft Advertising has keyword suggestions, the *Increase traffic* message appears at the top of the page. Select the **view** link.
  ...
  1. For the selections, do one or more of the following:
     ...
     - To use the suggested keywords in your campaigns, select **Apply**.
     - To first enter a different bid for a keyword, in the **First page bid** column, select the current bid and type a new amount. Then select **Apply**.
     - To reject the selected keywords, select **Reject** and select a reason.
...
- **Use Bid suggestions to update your keyword bids**
  ...
  1. Click **Attributes** > **Delivery** > **Eligible-limited** >**Below first page bid**, then click **Apply**.
...
- **Use Budget suggestions to update your budget**
  ...
  1. From the main menu on the far left, select **Campaigns**.
  1. If Microsoft Advertising has budget suggestions, the *Your ads aren't receiving as many impressions as possible* message appears at the top of the page. Select the **review** link.
  1. Select the arrow to the right of *Limited by budget* for the campaign you select, then do one of the following:

     - Select **Accept** to apply the budget amount suggested by Microsoft Advertising.
     - Enter your own updated budget amount, and then click **Accept** to apply it to the campaign.
     - Select **Close** to keep the existing budget amount.
     - Select **See more suggestions** to view the budget suggestions feature on the Recommendations tab of the Campaigns page.
