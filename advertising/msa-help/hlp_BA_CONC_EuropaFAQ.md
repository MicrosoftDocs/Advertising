...
> [!NOTE]
> - Most of our monthly invoice customers will have a business location and, if applicable, VAT information in our system. If you need to make changes, please contact your account manager or [Support](https://go.microsoft.com/fwlink/?linkid=398371).
...
> - If you have a VAT exemption certificate, please contact your account manager or [Support](https://go.microsoft.com/fwlink/?linkid=398371) to find out how to submit an electronic version of the document.

## Why is Microsoft Advertising subject to VAT in certain countries/regions?

Customers in Europe, the Middle East, Africa, and the Asia-Pacific area will be billed by Microsoft Ireland Operations Ltd. Because the billing entity is located in the European Union, the purchase of Microsoft Advertising advertising services is subject to VAT in some business locations.

## Who is required to pay VAT on advertising costs?
...
| Column 1 | Column 2 |
| --- | --- |
| **- Ireland<br>- Lichtenstein** | - Switzerland* |
...
| Column 1 | Column 2 |
| --- | --- |
| **- Austria<br>- Belgium<br>- Bulgaria<br>- Croatia<br>- Cyprus<br>- Czech Republic<br>- Denmark<br>- Estonia<br>- Finland*<br>- France<br>- Germany*<br>- Greece*<br>- Hungary<br>- Italy*<br>- Latvia** | - Lithuania<br>- Luxembourg<br>- Malta<br>- Monaco<br>- Netherlands<br>- New Zealand<br>- Poland<br>- Portugal<br>- Romania<br>- Slovakia<br>- Slovenia<br>- Spain*<br>- Sweden<br>- United Kingdom* |
...
To get information on taxes in these and other countries/regions, see [Tax or VAT information](hlp_BA_CONC_TaxVATInfo.md).
...
- **Adding a business location**
  ...
  1. Next to the **Account settings** page title, select the pencil icon ![edit icon](media/BA_icon_edit.png).
...
| --- | --- | --- |
| **Austria** | ATU12345678 | ATU + 8 digits |
| **Belgium** | BE0123456789 | 10 digits, may start with 0 |
| **Bulgaria** | BG123456789 / BG1234567890 | 9 or 10 digits |
| **Croatia** | HR12345678901 | 11 digits |
| **Cyprus** | CY12345678X | 8 digits + 1 letter |
| **Czech Republic** | CZ12345678 / CZ123456789 / CZ1234567890 | 8, 9, or 10 digits |
| **Denmark** | DK12345678 | 8 digits |
| **Estonia** | EE123456789 | 9 digits |
| **Finland** | FI12345678 | 8 digits |
| **France** | FRXX123456789 | 2 characters (letters or digits) + 9 digits |
| **Germany** | DE123456789 | 9 digits |
| **Greece** | EL123456789 | 9 digits |
| **Hungary** | HU12345678 | 8 digits |
| **Ireland** | IE1234567X / IE1X23456X | 7 digits + 1 letter or 1 digit + 1 letter + 5 digits + 1 letter |
| **Italy** | IT12345678901 | 11 digits |
| **Latvia** | LV12345678901 | 11 digits |
| **Lithuania** | LT123456789 / LT123456789012 | 9 or 12 digits |
| **Luxembourg** | LU12345678 | 8 digits |
| **Malta** | MT12345678 | 8 digits |
| **Netherlands** | NL123456789B01 | 9 digits + B + 2 digits |
| **Norway** | NO123456789MVA | 9 digits + MVA |
| **Poland** | PL1234567890 | 10 digits |
| **Portugal** | PT123456789 | 9 digits |
| **Romania** | RO123456789 | Up to 10 digits |
| **Slovakia** | SK1234567890 | 10 digits |
| **Slovenia** | SI12345678 | 8 digits |
| **Spain** | ESX1234567X | 1 letter + 7 digits + 1 letter |
| **Sweden** | SE123456789012 | 12 digits |

> [!NOTE]
> Validate your VAT number before entering it:
>
> - EU countries: Use the VIES VAT validation tool.
> - Non-EU countries: Use your national tax authority's lookup service.
> - If validation fails but your number is correct, contact MSASupport Support and provide: Your VAT certificate and a screenshot of the official validation result.
> - Allow up to 3 days for Microsoft to validate your VAT number after submission.
...
- **Country specific VAT registration number format**

  To ensure your VAT number is processed correctly, please be sure to follow the format listed for your country, which may require your two-letter country code (e.g., DE123456789 for Germany or NL123456789B01 for the Netherlands). This format helps us validate your information and apply the appropriate tax settings for your region.
...
- **I'm an agency. Do you want my company's business location or the business location for my client?**
  ...
  > [!NOTE]
  > If you're an agency based in India that advertises and pays the bill on behalf of a client, please make sure you enter your agency's business information so that it is reflected correctly on the billing documents.

- **I'm from a country/region that has VAT requirements. What changes will I see in my billing invoices and statements?**

  - **If you have provided a VAT registration number,**

    you will see your VAT registration number listed and a VAT 0% reverse charge in the subtotal section of your monthly invoice, statement, or credit memo.

  - **If you have not provided a VAT registration number,**

    you will see the VAT rate in the subtotal section and the charge to your account. The VAT rate is based on your local rate.

  - **If you have provided a VAT exemption certificate,**

    you will see on your invoice or statement that the certificate is **on file** and the VAT rate will be 0%.
