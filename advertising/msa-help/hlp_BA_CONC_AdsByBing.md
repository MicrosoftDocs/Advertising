...
> [!IMPORTANT]
> Starting March 31, 2022, you will no longer see ad suggestions for expanded text ads. If you have auto-apply for ad suggestions enabled, suggestions recommended until March 31, 2022 will continue to be applied until April 14, 2022. [Learn more about changes to expanded text ads](https://go.microsoft.com/fwlink/?linkid=2208402).
...
1. From the navigation menu on the left, hover over **Campaigns** and select **Recommendations**.
1. Select the ![ellipsis icon](media/BA_ScreenCap_DeliveryDetails.png) on the recommendation card for the type of recommendation you wish to stop seeing.
