...
Add compelling images to your [Audience ads](hlp_BA_CONC_NativeAds.md) to captivate your audience and enhance campaign performance to meet your advertising goals.

There are a few best practices to keep in mind when choosing images for your Audience ads:
...
- The more images you add increases ad variation, which can help attract more customers.
- Use images with the best performance in combination with your ad copy.

<a id="image-specifications"></a>

## Image specifications

> [!NOTE]
> If you advertise on the Google Display Network, Meta Audience Network, Yahoo Gemini, or with Pinterest Ads, you can import image assets from these platforms. You'll want to ensure that these images look correct in the Ad preview area during campaign creation, and if not, adjust or edit them accordingly.

- Accepted file types for images: .JPEG, .PNG
- Ensure that your images don't have text or logo overlays.
- High-resolution images only. Recommended dimensions: 1200 x 628 pixels or higher. Minimum dimensions: 703 x 368 pixels.
- There are no maximum dimensions or file size for Audience ad images.
- Images must be relevant to the ad and your landing page. We recommend that you include the same imagery on the ad's landing page to ensure relevance.
- Images must conform to the [Microsoft Advertising policies](https://go.microsoft.com/fwlink/?linkid=2295044).
...
> [!NOTE]
> [Learn more about audience marketing](hlp_BA_CONC_NativeAds.md).
