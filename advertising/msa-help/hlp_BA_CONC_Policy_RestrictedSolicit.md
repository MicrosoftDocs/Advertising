---
title: Solicitation of funds and fund-raising
ms.service: msa-help
...
Microsoft Advertising only accepts solicitation or fundraising ads from registered charities or recognized tax-exempt organizations. Crowd sourcing, such as GoFundMe or Kickstarter campaigns for example, are not allowed.

Solicitation or fundraising ads should comply with our [Offensive, Harmful, or Violent Content Policy](hlp_BA_CONC_Policy_DisallowedOffensive.md).

Microsoft Advertising prohibits the use of [Critical Events](hlp_BA_CONC_Policy_DisallowedSensitive.md) in fund-raising ad campaigns.
