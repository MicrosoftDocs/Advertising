...
- **Your ad group is not delivering or has the â€œPendingâ€ delivery status:** To help resolve this issue, please follow these steps:
...
- **Your ad group delivery status says â€œTargeting too narrowâ€:** See [Troubleshooting the â€œTargeting too narrowâ€ ad group delivery status](#troubleshooting-the-targeting-too-narrow-ad-group-delivery-status) for additional troubleshooting steps.

<a id="TroubleshootTargeting"></a>

## Troubleshooting the â€œTargeting too narrowâ€ ad group delivery status
