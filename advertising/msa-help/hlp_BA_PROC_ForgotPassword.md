...
| Usecase | Steps |
| --- | --- |
| **Then this is how to reset your password** | - Go to the Microsoft Advertising [sign-in page](https://ads.microsoft.com).<br>- Select **Forgot your user name?**<br>- Next to **I forgot my** select **Password**.<br>- Next to **Account email address**, enter the email address that you use as your contact email address for Microsoft Advertising (the email address that we use to send you information about Microsoft Advertising.)<br>- Enter the answer to your security question.<br>- Select **Submit**.<br>Microsoft Advertising will send you an email with instructions on resetting your password.<br>- Follow the instructions in the email to finish resetting your password.<br>If you don't receive the email, check your junk mail folder. |

### If you sign in with an email address (a Microsoft account)

| Usecase | Steps |
| --- | --- |
| **Then this is how to reset your password** | - Go to the Microsoft Advertising [sign-in page](https://ads.microsoft.com).<br>- Enter your email address and select **Next** to be directed to the Microsoft account sign-in page.<br>- Select **Can't access your account?**<br>- Enter your email address, enter the characters you see on the page, and then select **Next**.<br>Microsoft will send you a security code via email or text.<br>- Enter the security code and select **Next**.<br>- Enter your new password, re-enter your new password, and then select **Next**.<br>If you don't receive the email, check your junk mail folder. |
