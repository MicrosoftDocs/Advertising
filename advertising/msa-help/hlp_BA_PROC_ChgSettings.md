...
1. Select **Apply**.
1. Hover over the field you want to edit and select the pencil icon ![pencil icon](media/BA_icon_edit.png) .
...
1. To set the budget to a specific amount: In the **Action** dropdown menu, select **Set**. Enter the amount you want to set the budgets to. Select **Save**.
1. To increase the budgets by a specific percentage or amount: In the **Action** dropdown menu, choose **Increase**. Enter the percentage or amount you want to increase your budgets by. Select **Save**.
1. To decrease the budgets by a specific percentage or amount: In the **Action** dropdown menu, choose **Decrease**. Enter the percentage or amount you want to decrease your budgets by. Select **Save**.

## Change the end date for one or more campaigns

1. From the navigation menu on the left, select **Campaigns**.
1. Find the campaign you want to set an end date for and select the checkbox next to it.
1. In the blue bar, select **Edit** > **Other changes**.
1. From the **Campaign settings** dropdown, choose **End date**.
1. Choose your desired end date for the campaign.
1. Select **Apply**.

## Change the status, bids, or end dates for an ad group
...
1. Hover over the field you want to edit and select the pencil icon ![pencil icon](media/BA_icon_edit.png) .
1. After you are done making your changes, select **Save**.<br>
