...
| --- | --- | --- |
| **Prepay** | Add funds to your account and have charges deducted from those funds. | ![](media/BA_Conc_PrepayCoins.png) |
|  |  |  |
| **Postpay** | Pay on a regular basis after charges accrue.<br>There are two postpay billing options: | ![](media/BA_Conc_PostpayCoins.png) |

| Column 1 | Column 2 | Column 3 |
| --- | --- | --- |
|  | ![](media/BA_Conc_PrePayPostPayDottedLines.png) |  |
