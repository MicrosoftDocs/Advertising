...
1. Copy your tracking tag. You can find it here: From the navigation menu on the left, hover over **Campaigns** and select **Campaigns** > **Campaign details** for the campaign you want to edit.
1. In the **Customer action tracking** pane, select the ![ellipsis icon](media/BA_ScreenCap_DeliveryDetails.png) and select **View tracking tag**.
1. Open the HTML for each webpage of your website.
1. Paste the tracking tag anywhere in the head section of your website's codeâ€”in other words, before the closing head tag: "</head>".
