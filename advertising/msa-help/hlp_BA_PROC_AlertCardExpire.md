...
:::image type="content" source="media/BA_ScreenCap_PaymentMethodExpired.png" alt-text="Payment method with a label marked &quot;Expired&quot;.":::
...
- **Update the expiration date for your card**
  ...
  1. Next to the card you want to update, select **Edit**.
...
- **Use a different payment method**
  ...
  1. Next to the payment method you want to use, select **Set as primary**.<br> or<br> If you need to add a new payment method, select **Add card**, add the payment method information, and then select **Set as primary**. For more information, see [Paying by credit and debit card](hlp_BA_PROC_AddBilling.md)

- **Pause or enable a campaign**

  1. Select the **Campaigns** page.
  1. Select the check box next to the campaign.
  1. Select **Edit** and then **Pause** or **Enable**.
