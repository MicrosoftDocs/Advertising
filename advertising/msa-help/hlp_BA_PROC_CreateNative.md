...
For more information about best practices for adding images to your Native ads, see [Best practices for Audience ad images](hlp_BA_CONC_ImagesForAudienceAds.md). Here's an example of what Native ads with images could look like:

:::image type="content" source="media/BA_Conc_ImageBasedAds.png" alt-text="Sample image-based Audience ad.":::

## Create a Native ad in an existing campaign

To create Native ads in an existing Audience campaign, follow the instructions below. To create a new Audience campaign with Native ads, see [How do I create an Audience campaign?](hlp_BA_PROC_CreateAudienceCampaign.md)
...
1. (Optional) Below **Videos**, you can add up to five videos that you want to appear in your ad. You may also choose to add our **Recommended videos**.

   If you choose to add **Recommended videos**:
   ...
   > [!NOTE]
   > See [Technical requirements for videos](#technical-requirements-for-videos) for information about the technical requirements for videos.
...
> [!NOTE]
> - After you select **Save**, your ads will begin appearing on the [Microsoft Advertising Network](hlp_BA_CONC_AboutAdvertisingNetwork.md) shortly, unless there is [an error with your account](hlp_BA_CONC_AccountErrors.md).
...
Videos for Native ads have the same technical requirements as Online Video ads. For a complete list of technical requirements, see [About Online Video ads](hlp_BA_CONC_AboutVideoAds.md).
