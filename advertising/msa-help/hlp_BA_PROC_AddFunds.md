...
Manually add funds to a prepay account From the navigation menu on the left, hover over **Billing** and select **Payment methods**. If you have multiple accounts, choose one from the account selector in the top menu. From **Billing Summary** in the **Current balance** tile, select **Add funds**. On the **Add funds** form, follow the instructions. Instructions vary based on your payment method. Select **Pay now**. Set up auto-recharge for a prepay account If you sign up for auto-recharge, each time your account balance reaches 20 percent of the recharge amount, we will automatically charge your primary payment method and add funds to your account. To set up auto-recharge, you need to make sure that you are using a card, PayPal, or SEPA direct debit as your primary payment method. From the navigation menu on the left, hover over **Billing** and select **Payment methods**. If you have multiple accounts, choose one from the account selector in the top menu. From **Billing summary**, in the **Current balance** tile, select **Set up auto-recharge**. Slide the switch to the right next to **Auto-recharge settings**, select or enter a custom amount, and select **Save**. Check remaining prepay balance From the navigation menu on the left, hover over **Billing** and select **Billing Summary** From **Billing Summary** in the **Current balance** tile, you can view your remaining balance.
