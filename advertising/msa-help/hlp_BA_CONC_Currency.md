...
### Don't see your currency in the list above?

You might still be able to advertise with Microsoft Advertising. Check with the financial institution that issues your card to make sure that they allow international transactions. If they do, you can select any currency that your financial institution can convert into your local currency.
...
<a id="what-can-i-do-if-i-selected-the-wrong-currency"></a>
...
- **Create a new account**
  ...
  1. On the **Account Summary** tab, select **Create account**.
...
- **Import campaign information into your new account**
  ...
  1. Select **Browse**, select the file that you exported, and then select **Continue**.
  1. Under **Review Column Matching**, select **Continue**.
  1. Under **Choose Microsoft Advertising Account & Import Options**, select the new account you created, select the time zone, and then select **Import**.

## How to view the currency your account uses

1. From the navigation menu on the left, hover over **Billing** and select **Billing summary**.
1. You'll be able to view your account currency with your current account balance.
