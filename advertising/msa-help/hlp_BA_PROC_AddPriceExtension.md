...
:::image type="content" source="media/BA_Conc_Extension_Price_PC.png" alt-text="Price extension on PC.":::

:::image type="content" source="media/BA_Conc_Extension_Price_Mobile.png" alt-text="Price extension on mobile.":::
...
> [!IMPORTANT]
> - All extension details must adhere to our [price extension policies](hlp_BA_CONC_Policy_AdExtensionPolicies.md).
> - Each price extension must have a minimum of three items and a maximum of eight items (Header, Description, Price qualifier, Price, Unit, Final URL, or Final Mobile URL).
