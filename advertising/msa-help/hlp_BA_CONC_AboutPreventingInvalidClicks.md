...
- **Monitor the Traffic sources report for traffic that may not be ideal for your business**
  ...
  **Why**: Understand where your business’s high performing traffic comes from and exclude websites that you don’t want. You can find the **Website URL** report on the **Reports** page. For more information, see [Understanding the Report Builder](hlp_BA_PROC_CreateReport.md).
