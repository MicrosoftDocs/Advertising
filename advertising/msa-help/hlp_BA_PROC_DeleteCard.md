...
You can delete a credit card, debit card, or other payment method, unless it is set as the primary payment method for an account. If it is, then you'll need to set a new one before you can delete the payment method. For more info, see [How to change payment methods and bill-to customer](hlp_BA_PROC_Account_AssociateCCard.md).
