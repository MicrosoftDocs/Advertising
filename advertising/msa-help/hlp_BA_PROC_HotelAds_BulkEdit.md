...
| **Type: **Ad group check in day criterion**. Add the following columns: **Target** (supported values: **Monday** â€¦ **Sunday**)** | Adjust your bids based on the day of check in at the property.<br>- To increase a day's bid by 20%, you would enter 20 in the Bid adjustment column.<br>- To decrease a day's bid by 15%, you would enter -15 in the Bid adjustment column. |
