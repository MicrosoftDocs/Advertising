...
> [!NOTE]
> To view the Campaign ID for your campaign (the unique number that Microsoft Advertising uses to identify your campaign), see [Add and remove columns](#add-and-remove-columns) below. Once you add the **Campaign ID** column in your **Campaigns** page, you'll be able to check which ID your campaign is assocaited with by reviewing the column.
...
1. Under **Modify columns**, select each category and then add or remove columns. You can select from predefined columns or create [custom columns](hlp_BA_CONC_CustomColumns.md). For instance, if you want to add the Campaign ID column in the **Campaigns** page, select the Attributes category and then select **Add** next to **Campaign ID**.
