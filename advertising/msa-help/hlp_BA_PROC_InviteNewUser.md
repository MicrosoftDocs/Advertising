...
- When accepting an invitation, make sure that you're logged out of any alternate email accounts or use an InPrivate/Incognito browser when attempting to activate your account.
- Paste the invitation link into your browser's address bar. If the activation link still doesn't work, create a new Microsoft account and try again.

If the troubleshooting steps above don't resolve the issue, please [contact Support](https://go.microsoft.com/fwlink/?linkid=398371).
