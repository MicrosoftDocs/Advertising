...
:::image type="content" source="media/BA_CONC_AddVideoExtension_desktop.png" alt-text="Video extension with Search ad on computer.":::

:::image type="content" source="media/BA_CONC_AddVideoExtension_DesktopPlayer.png" alt-text="Video extension with Search ad on mobile.":::

On computer, when a user clicks on your thumbnail image, your video plays in a full-screen overlay above the **Display text** and **Action text**. Viewers can watch the video, and then click on the call to action button or the text in your ad. On mobile, the video plays in the frame with the **Display text**. The thumbnail image provides an opportunity to engage viewers and generate views. Video extensions operate best when the video complements your ad with unique content rather than repeating what users can already read in the text.

:::image type="content" source="media/BA_CONC_AddVideoExtension_mobile.png" alt-text="Video extensions player on computer.":::
...
> [!NOTE]
> Make sure that the media you use meets Microsoft Advertising [image, audio, and video policies.](hlp_BA_CONC_Policy_GeneralAdRequirements.md)
