...
[getName](#getname)|string|Gets the product's brand name.
[getStats](#getstats)|[Stats](Stats.md)|Gets the performance data for this product group.
[getValue](#getvalue)sString|Gets this product group's value.
...
|Type|Description|
|-|-
String|This product group's dimension, which is set to BRAND.
...
|Type|Description|
|-|-
string|This entity's type, which is *ProductBrand*.
...
|Type|Description|
|-|-
string|The product's brand name. This is the same value that the [getName](#getname) method returns.
